...
export declare class Deployments {
     ...
     */
    prepareStack(options: PrepareStackOptions): Promise<SuccessfulDeployStackResult | undefined>;
    /**
     ...
     */
    cleanupChangeSet(stack: cxapi.CloudFormationStackArtifact, changeSetName: string): Promise<void>;
    /**
     ...
     */
    describeChangeSet(stack: cxapi.CloudFormationStackArtifact, changeSetName: string, stackArn?: string): Promise<DescribeChangeSetCommandOutput>;
