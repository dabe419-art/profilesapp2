...
import type { PipelineProps as BlocksPipelineProps, BranchConfig, PipelineSourceConfig, PipelineStageConfig, PipelineSynthConfig } from '@aws-blocks/pipeline';
export type { BranchConfig, PipelineSourceConfig, PipelineStageConfig, PipelineSynthConfig, } from '@aws-blocks/pipeline';
/**
 ...
 * ```
 */
export type PipelineProps<TConfig = Record<string, unknown>> = BlocksPipelineProps<TConfig> & {
    /**
