...
const isBiggerThanNMinus2 = (value) => {
...
const sha256 = createHasher(() => new _SHA256(), oidNist(0x01));
...
const _0n$2 = BigInt(0), _1n$2 = BigInt(1), _2n$1 = BigInt(2);
const _3n$1 = BigInt(3), _4n$1 = BigInt(4), _5n = BigInt(5);
const _7n = BigInt(7), _8n = BigInt(8), _9n = BigInt(9);
...
const p256_Point = weierstrass(p256_CURVE);
const p256 = ecdsa(p256_Point, sha256);
class Ec {
    constructor(curve) {
        if (curve !== "p256")
