...
import { ApplicationReference, ConfigurationProfileReference, DeploymentReference, DeploymentStrategyReference, EnvironmentReference, ExperimentDefinitionReference, ExperimentRunReference, ExtensionAssociationReference, ExtensionReference, HostedConfigurationVersionReference, IApplicationRef, IConfigurationProfileRef, IDeploymentRef, IDeploymentStrategyRef, IEnvironmentRef, IExperimentDefinitionRef, IExperimentRunRef, IExtensionAssociationRef, IExtensionRef, IHostedConfigurationVersionRef } from "../../interfaces/generated/aws-appconfig-interfaces.generated";
 ...
 */
export declare class CfnExperimentRun extends cdk.CfnResource implements cdk.IInspectable, IExperimentRunRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnExperimentRun from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnExperimentRun;
    /**
     * Checks whether the given object is a CfnExperimentRun
     */
    static isCfnExperimentRun(x: any): x is CfnExperimentRun;
    /**
     ...
     */
    private _experimentDefinitionIdentifier;
    /**
     * Percentage of traffic exposed to the experiment (0-100).
     */
    private _exposurePercentage;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnExperimentRunProps);
    get experimentRunRef(): ExperimentRunReference;
    /**
     * The application name or ID used to create the experiment run.
     */
    get applicationIdentifier(): string;
     ...
     * The experiment definition name or ID used to create the experiment run.
     */
    get experimentDefinitionIdentifier(): string;
    /**
     * The experiment definition name or ID used to create the experiment run.
     */
    set experimentDefinitionIdentifier(value: string);
    /**
     * Percentage of traffic exposed to the experiment (0-100).
     */
     ...
     * Percentage of traffic exposed to the experiment (0-100).
     */
    set exposurePercentage(value: number);
    /**
     * Tags to associate with the experiment run.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * Treatment overrides for specific entities.
     */
    get treatmentOverrides(): cdk.IResolvable | CfnExperimentRun.TreatmentOverridesProperty | undefined;
    /**
     * Treatment overrides for specific entities.
     */
    set treatmentOverrides(value: cdk.IResolvable | CfnExperimentRun.TreatmentOverridesProperty | undefined);
    /**
     ...
     */
    get attrExperimentDefinitionId(): string;
    /**
...
export declare namespace CfnExperimentRun {
    /**
     * Treatment overrides for specific entities.
     *
     * @struct
    ...
    interface TreatmentOverridesProperty {
         ...
         */
        readonly inline?: cdk.IResolvable | Record<string, string>;
    }
}
/**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-experimentrun.html
 */
export interface CfnExperimentRunProps {
    /**
     * The application name or ID used to create the experiment run.
     *
     ...
     */
    readonly treatmentOverrides?: cdk.IResolvable | CfnExperimentRun.TreatmentOverridesProperty;
}
...
export type { IExperimentRunRef, ExperimentRunReference };
