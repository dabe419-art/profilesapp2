...
export declare class CfnRouterOutput extends cdk.CfnResource implements cdk.IInspectable, IRouterOutputRef, cdk.ITaggableV2 {
     ...
     * The fabric configuration settings for the router output.
     */
    get fabricConfiguration(): CfnRouterOutput.FabricConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The fabric configuration settings for the router output.
     */
    set fabricConfiguration(value: CfnRouterOutput.FabricConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The maintenance configuration settings applied to this router output.
     */
...
export interface CfnRouterOutputProps {
     ...
     */
    readonly fabricConfiguration?: CfnRouterOutput.FabricConfigurationProperty | cdk.IResolvable;
    /**
     * The maintenance configuration settings applied to this router output.
     *
