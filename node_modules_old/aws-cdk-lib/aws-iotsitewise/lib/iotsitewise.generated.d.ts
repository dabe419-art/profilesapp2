...
export declare class CfnPipeline extends cdk.CfnResource implements cdk.IInspectable, IPipelineRef, cdk.ITaggableV2 {
     ...
     * The list of compute nodes that form the pipeline DAG.
     */
    get computations(): Array<CfnPipeline.ComputeNodeProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The list of compute nodes that form the pipeline DAG.
     */
    set computations(value: Array<CfnPipeline.ComputeNodeProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * A description of the pipeline.
     */
...
export interface CfnPipelineProps {
     ...
     */
    readonly computations: Array<CfnPipeline.ComputeNodeProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A description of the pipeline.
     *
 ...
 */
export declare class CfnTask extends cdk.CfnResource implements cdk.IInspectable, ITaskRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     * The task execution configuration.
     */
    get taskConfiguration(): cdk.IResolvable | CfnTask.TaskConfigurationProperty;
    /**
     * The task execution configuration.
     */
    set taskConfiguration(value: cdk.IResolvable | CfnTask.TaskConfigurationProperty);
    /**
     * The name of the task.
     */
    get taskName(): string;
...
export declare namespace CfnTask {
    ...
    interface TaskConfigurationProperty {
         ...
         */
        readonly containerTaskConfiguration: CfnTask.ContainerTaskConfigurationProperty | cdk.IResolvable;
    }
    /**
     * Configuration for running a custom container image on managed compute.
     *
...
export interface CfnTaskProps {
     ...
     */
    readonly taskConfiguration: cdk.IResolvable | CfnTask.TaskConfigurationProperty;
    /**
     * The name of the task.
     *
     * Must be unique within the workspace.
...
export declare class CfnWorkspace extends cdk.CfnResource implements cdk.IInspectable, IWorkspaceRef, cdk.ITaggableV2 {
     ...
     * The encryption configuration for the workspace.
     */
    get encryptionConfiguration(): CfnWorkspace.EncryptionConfigurationProperty | cdk.IResolvable;
    /**
     * The encryption configuration for the workspace.
     */
    set encryptionConfiguration(value: CfnWorkspace.EncryptionConfigurationProperty | cdk.IResolvable);
    /**
     * The ARN of the AWS KMS key used for KMS_BASED_ENCRYPTION.
     */
     ...
     * A description of the workspace.
     */
    set workspaceDescription(value: string | undefined);
    /**
     * The name of the workspace.
     */
    get workspaceName(): string;
...
export interface CfnWorkspaceProps {
     ...
     */
    readonly encryptionConfiguration: CfnWorkspace.EncryptionConfigurationProperty | cdk.IResolvable;
    /**
     * The ARN of the AWS KMS key used for KMS_BASED_ENCRYPTION.
     *
