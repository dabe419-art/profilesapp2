...
export declare class FoundationModelIdentifier {
    ...
    static readonly OPENAI_GPT_OSS_SAFEGUARD_120B: FoundationModelIdentifier;
    /** Base model "openai.gpt-oss-safeguard-20b". */
    static readonly OPENAI_GPT_OSS_SAFEGUARD_20B: FoundationModelIdentifier;
    /** Base model "openai.gpt-5.4". */
    static readonly OPENAI_GPT_5_4: FoundationModelIdentifier;
    /** Base model "openai.gpt-5.5". */
    static readonly OPENAI_GPT_5_5: FoundationModelIdentifier;
    /** Base model "openai.gpt-5.6-sol". */
    static readonly OPENAI_GPT_5_6_SOL: FoundationModelIdentifier;
    /** Base model "openai.gpt-5.6-terra". */
    static readonly OPENAI_GPT_5_6_TERRA: FoundationModelIdentifier;
    /** Base model "openai.gpt-5.6-luna". */
    static readonly OPENAI_GPT_5_6_LUNA: FoundationModelIdentifier;
    /** Base model "openai.gpt-5.6-cyber". */
    static readonly OPENAI_GPT_5_6_CYBER: FoundationModelIdentifier;
    /** Base model "openai.gpt-daybreak-blue-5.6-sol". */
    static readonly OPENAI_GPT_DAYBREAK_BLUE_5_6_SOL: FoundationModelIdentifier;
