...
export declare class CfnFeed extends cdk.CfnResource implements cdk.IInspectable, IFeedRef, cdk.ITaggableV2 {
    ...
    get accessRoleArn(): string | undefined;
    set accessRoleArn(value: string | undefined);
    get name(): string;
    set name(value: string);
...
export declare namespace CfnFeed {
    ...
    interface OutputConfigProperty {
         ...
         */
        readonly cropping?: CfnFeed.CroppingConfigProperty | cdk.IResolvable;
        /**
     ...
     */
    interface CroppingConfigProperty {
        /**
         ...
         */
        readonly templateGroups?: Array<cdk.IResolvable | CfnFeed.TemplateGroupProperty> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface TemplateGroupProperty {
         ...
         */
        readonly templateUris: Array<string>;
    }
    /**
     * @struct
     * @stability external
    ...
    interface ClippingConfigProperty {
         ...
         */
        readonly dataSourceConfiguration?: CfnFeed.DataSourceConfigurationProperty | cdk.IResolvable;
    }
    /**
     * Identifies the fixture whose event data Elemental Inference maps onto the clipping metadata for an output.
     *
