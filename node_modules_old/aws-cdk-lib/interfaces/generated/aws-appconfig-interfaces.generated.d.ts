...
/**
 * Indicates that this resource can be referenced as a ExperimentRun.
 *
 * @stability experimental
 */
export interface IExperimentRunRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ExperimentRun resource.
     */
    readonly experimentRunRef: ExperimentRunReference;
}
/**
 * A reference to a ExperimentRun resource.
 *
