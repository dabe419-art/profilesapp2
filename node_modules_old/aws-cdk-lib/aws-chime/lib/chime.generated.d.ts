...
import { AppInstanceBotReference, AppInstanceReference, AppInstanceUserReference, ChannelFlowReference, IAppInstanceBotRef, IAppInstanceRef, IAppInstanceUserRef, IChannelFlowRef, IMediaPipelineKinesisVideoStreamPoolRef, MediaPipelineKinesisVideoStreamPoolReference } from "../../interfaces/generated/aws-chime-interfaces.generated";
/**
 ...
 */
export declare class CfnAppInstanceUser extends cdk.CfnResource implements cdk.IInspectable, IAppInstanceUserRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnAppInstanceUser from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAppInstanceUser;
    /**
     * Checks whether the given object is a CfnAppInstanceUser
     */
    static isCfnAppInstanceUser(x: any): x is CfnAppInstanceUser;
    static arnForAppInstanceUser(resource: IAppInstanceUserRef): string;
    private _appInstanceArn;
    private _appInstanceUserId;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
    private _expirationSettings?;
    private _metadata?;
    private _name?;
    private _tags?;
    protected readonly cfnPropertyNames: Record<string, string>;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnAppInstanceUserProps);
    get appInstanceUserRef(): AppInstanceUserReference;
    get appInstanceArn(): string;
    set appInstanceArn(value: string);
    get appInstanceUserId(): string;
    set appInstanceUserId(value: string);
    get expirationSettings(): CfnAppInstanceUser.ExpirationSettingsProperty | cdk.IResolvable | undefined;
    set expirationSettings(value: CfnAppInstanceUser.ExpirationSettingsProperty | cdk.IResolvable | undefined);
    get metadata(): string | undefined;
    set metadata(value: string | undefined);
    get name(): string | undefined;
    set name(value: string | undefined);
     ...
     */
    get attrAppInstanceUserArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnAppInstanceUser {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chime-appinstanceuser.html
 */
export interface CfnAppInstanceUserProps {
    /**
     ...
     */
    readonly expirationSettings?: CfnAppInstanceUser.ExpirationSettingsProperty | cdk.IResolvable;
    /**
 ...
 */
export declare class CfnChannelFlow extends cdk.CfnResource implements cdk.IInspectable, IChannelFlowRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnChannelFlow from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnChannelFlow;
    /**
     * Checks whether the given object is a CfnChannelFlow
     */
    static isCfnChannelFlow(x: any): x is CfnChannelFlow;
    static arnForChannelFlow(resource: IChannelFlowRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnChannelFlowProps);
    get channelFlowRef(): ChannelFlowReference;
    /**
     * The ARN of the app instance.
     */
    get appInstanceArn(): string;
     ...
     * Information about the processor Lambda functions.
     */
    get processors(): Array<cdk.IResolvable | CfnChannelFlow.ProcessorProperty> | cdk.IResolvable;
    /**
     * Information about the processor Lambda functions.
     */
    set processors(value: Array<cdk.IResolvable | CfnChannelFlow.ProcessorProperty> | cdk.IResolvable);
    /**
     * The tags for the channel flow.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare namespace CfnChannelFlow {
    /**
    ...
    interface ProcessorProperty {
         ...
         */
        readonly configuration: cdk.IResolvable | CfnChannelFlow.ProcessorConfigurationProperty;
        /**
    ...
    interface ProcessorConfigurationProperty {
         ...
         */
        readonly lambda: cdk.IResolvable | CfnChannelFlow.LambdaConfigurationProperty;
    }
    /**
     * Stores metadata about a Lambda processor.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chime-channelflow.html
 */
export interface CfnChannelFlowProps {
    /**
     * The ARN of the app instance.
     *
     ...
     */
    readonly processors: Array<cdk.IResolvable | CfnChannelFlow.ProcessorProperty> | cdk.IResolvable;
    /**
     * The tags for the channel flow.
     *
 ...
 */
export declare class CfnMediaPipelineKinesisVideoStreamPool extends cdk.CfnResource implements cdk.IInspectable, IMediaPipelineKinesisVideoStreamPoolRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnMediaPipelineKinesisVideoStreamPool from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnMediaPipelineKinesisVideoStreamPool;
    /**
     * Checks whether the given object is a CfnMediaPipelineKinesisVideoStreamPool
     */
    static isCfnMediaPipelineKinesisVideoStreamPool(x: any): x is CfnMediaPipelineKinesisVideoStreamPool;
    static arnForMediaPipelineKinesisVideoStreamPool(resource: IMediaPipelineKinesisVideoStreamPoolRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnMediaPipelineKinesisVideoStreamPoolProps);
    get mediaPipelineKinesisVideoStreamPoolRef(): MediaPipelineKinesisVideoStreamPoolReference;
    /**
     * The name of the Kinesis Video Stream Pool.
     */
    get poolName(): string;
     ...
     * The configuration settings for the Kinesis video stream.
     */
    get streamConfiguration(): cdk.IResolvable | CfnMediaPipelineKinesisVideoStreamPool.StreamConfigurationProperty;
    /**
     * The configuration settings for the Kinesis video stream.
     */
    set streamConfiguration(value: cdk.IResolvable | CfnMediaPipelineKinesisVideoStreamPool.StreamConfigurationProperty);
    /**
     * The tags associated with the Kinesis Video Stream Pool.
     */
    get tags(): Array<CfnMediaPipelineKinesisVideoStreamPool.TagsItemsProperty> | undefined;
    /**
     * The tags associated with the Kinesis Video Stream Pool.
     */
    set tags(value: Array<CfnMediaPipelineKinesisVideoStreamPool.TagsItemsProperty> | undefined);
    /**
...
export declare namespace CfnMediaPipelineKinesisVideoStreamPool {
    /**
     * The configuration settings for the Kinesis video stream.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chime-mediapipelinekinesisvideostreampool.html
 */
export interface CfnMediaPipelineKinesisVideoStreamPoolProps {
    /**
     * The name of the Kinesis Video Stream Pool.
     *
     ...
     */
    readonly streamConfiguration: cdk.IResolvable | CfnMediaPipelineKinesisVideoStreamPool.StreamConfigurationProperty;
    /**
     * The tags associated with the Kinesis Video Stream Pool.
     *
     ...
     */
    readonly tags?: Array<CfnMediaPipelineKinesisVideoStreamPool.TagsItemsProperty>;
}
export type { IAppInstanceRef, AppInstanceReference };
export type { IAppInstanceBotRef, AppInstanceBotReference };
export type { IAppInstanceUserRef, AppInstanceUserReference };
export type { IChannelFlowRef, ChannelFlowReference };
export type { IMediaPipelineKinesisVideoStreamPoolRef, MediaPipelineKinesisVideoStreamPoolReference };
