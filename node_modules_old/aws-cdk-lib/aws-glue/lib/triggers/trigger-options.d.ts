...
export declare abstract class Action {
     ...
     */
    static job(job: IJobRef, options?: JobActionOptions): Action;
    /**
     ...
     * @param options additional options for the action.
     */
    static crawler(crawler: ICrawlerRef, options?: CrawlerActionOptions): Action;
    /**
     * Render this action to its CloudFormation representation.
     *
     * @internal
     */
    abstract _render(): CfnTrigger.ActionProperty;
}
/**
 * Represents a trigger schedule.
 */
export declare class TriggerSchedule {
     ...
     */
    static cron(options: events.CronOptions): TriggerSchedule;
    /**
...
export declare abstract class Condition {
     ...
     */
    static job(job: IJobRef, state: JobState, options?: ConditionOptions): Condition;
    /**
     ...
     * @param options additional options for the condition.
     */
    static crawler(crawler: ICrawlerRef, crawlState: CrawlerState, options?: ConditionOptions): Condition;
    /**
     * Render this condition to its CloudFormation representation.
     *
     * @internal
     */
    abstract _render(): CfnTrigger.ConditionProperty;
}
/**
