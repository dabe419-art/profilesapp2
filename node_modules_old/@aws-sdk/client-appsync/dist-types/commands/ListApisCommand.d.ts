...
declare const ListApisCommand_base: {
    new (input: ListApisCommandInput): import("@smithy/core/client").CommandImpl<ListApisCommandInput, ListApisCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListApisCommandInput]): import("@smithy/core/client").CommandImpl<ListApisCommandInput, ListApisCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
