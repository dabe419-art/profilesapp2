...
declare const CreateApiKeyCommand_base: {
    new (input: CreateApiKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateApiKeyCommandInput, CreateApiKeyCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateApiKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateApiKeyCommandInput, CreateApiKeyCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
