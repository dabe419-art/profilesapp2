...
declare const CreateApiCacheCommand_base: {
    new (input: CreateApiCacheCommandInput): import("@smithy/core/client").CommandImpl<CreateApiCacheCommandInput, CreateApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateApiCacheCommandInput): import("@smithy/core/client").CommandImpl<CreateApiCacheCommandInput, CreateApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
