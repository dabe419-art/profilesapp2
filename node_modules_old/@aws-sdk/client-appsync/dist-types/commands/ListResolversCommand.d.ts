...
declare const ListResolversCommand_base: {
    new (input: ListResolversCommandInput): import("@smithy/core/client").CommandImpl<ListResolversCommandInput, ListResolversCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListResolversCommandInput): import("@smithy/core/client").CommandImpl<ListResolversCommandInput, ListResolversCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
