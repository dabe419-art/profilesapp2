...
import type { AssociateSourceGraphqlApiRequest, AssociateSourceGraphqlApiResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateSourceGraphqlApiCommand_base: {
    new (input: AssociateSourceGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<AssociateSourceGraphqlApiCommandInput, AssociateSourceGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateSourceGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<AssociateSourceGraphqlApiCommandInput, AssociateSourceGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
