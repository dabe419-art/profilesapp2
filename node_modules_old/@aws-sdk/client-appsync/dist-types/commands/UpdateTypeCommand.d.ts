...
declare const UpdateTypeCommand_base: {
    new (input: UpdateTypeCommandInput): import("@smithy/core/client").CommandImpl<UpdateTypeCommandInput, UpdateTypeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateTypeCommandInput): import("@smithy/core/client").CommandImpl<UpdateTypeCommandInput, UpdateTypeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
