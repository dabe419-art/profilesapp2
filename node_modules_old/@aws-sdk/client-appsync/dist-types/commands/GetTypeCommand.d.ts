...
declare const GetTypeCommand_base: {
    new (input: GetTypeCommandInput): import("@smithy/core/client").CommandImpl<GetTypeCommandInput, GetTypeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTypeCommandInput): import("@smithy/core/client").CommandImpl<GetTypeCommandInput, GetTypeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
