...
declare const ListDataSourcesCommand_base: {
    new (input: ListDataSourcesCommandInput): import("@smithy/core/client").CommandImpl<ListDataSourcesCommandInput, ListDataSourcesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDataSourcesCommandInput): import("@smithy/core/client").CommandImpl<ListDataSourcesCommandInput, ListDataSourcesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
