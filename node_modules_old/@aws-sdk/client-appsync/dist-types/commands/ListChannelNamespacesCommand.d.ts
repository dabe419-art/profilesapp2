...
declare const ListChannelNamespacesCommand_base: {
    new (input: ListChannelNamespacesCommandInput): import("@smithy/core/client").CommandImpl<ListChannelNamespacesCommandInput, ListChannelNamespacesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListChannelNamespacesCommandInput): import("@smithy/core/client").CommandImpl<ListChannelNamespacesCommandInput, ListChannelNamespacesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
