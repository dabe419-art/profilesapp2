...
declare const UpdateDataSourceCommand_base: {
    new (input: UpdateDataSourceCommandInput): import("@smithy/core/client").CommandImpl<UpdateDataSourceCommandInput, UpdateDataSourceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDataSourceCommandInput): import("@smithy/core/client").CommandImpl<UpdateDataSourceCommandInput, UpdateDataSourceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
