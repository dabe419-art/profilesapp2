...
import type { FlushApiCacheRequest, FlushApiCacheResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const FlushApiCacheCommand_base: {
    new (input: FlushApiCacheCommandInput): import("@smithy/core/client").CommandImpl<FlushApiCacheCommandInput, FlushApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: FlushApiCacheCommandInput): import("@smithy/core/client").CommandImpl<FlushApiCacheCommandInput, FlushApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
