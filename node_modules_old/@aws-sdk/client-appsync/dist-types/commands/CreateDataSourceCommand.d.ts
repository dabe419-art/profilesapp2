...
declare const CreateDataSourceCommand_base: {
    new (input: CreateDataSourceCommandInput): import("@smithy/core/client").CommandImpl<CreateDataSourceCommandInput, CreateDataSourceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDataSourceCommandInput): import("@smithy/core/client").CommandImpl<CreateDataSourceCommandInput, CreateDataSourceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
