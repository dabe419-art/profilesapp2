...
declare const EvaluateCodeCommand_base: {
    new (input: EvaluateCodeCommandInput): import("@smithy/core/client").CommandImpl<EvaluateCodeCommandInput, EvaluateCodeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EvaluateCodeCommandInput): import("@smithy/core/client").CommandImpl<EvaluateCodeCommandInput, EvaluateCodeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
