...
declare const CreateChannelNamespaceCommand_base: {
    new (input: CreateChannelNamespaceCommandInput): import("@smithy/core/client").CommandImpl<CreateChannelNamespaceCommandInput, CreateChannelNamespaceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateChannelNamespaceCommandInput): import("@smithy/core/client").CommandImpl<CreateChannelNamespaceCommandInput, CreateChannelNamespaceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
