...
declare const GetGraphqlApiEnvironmentVariablesCommand_base: {
    new (input: GetGraphqlApiEnvironmentVariablesCommandInput): import("@smithy/core/client").CommandImpl<GetGraphqlApiEnvironmentVariablesCommandInput, GetGraphqlApiEnvironmentVariablesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGraphqlApiEnvironmentVariablesCommandInput): import("@smithy/core/client").CommandImpl<GetGraphqlApiEnvironmentVariablesCommandInput, GetGraphqlApiEnvironmentVariablesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
