...
declare const ListSourceApiAssociationsCommand_base: {
    new (input: ListSourceApiAssociationsCommandInput): import("@smithy/core/client").CommandImpl<ListSourceApiAssociationsCommandInput, ListSourceApiAssociationsCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListSourceApiAssociationsCommandInput): import("@smithy/core/client").CommandImpl<ListSourceApiAssociationsCommandInput, ListSourceApiAssociationsCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
