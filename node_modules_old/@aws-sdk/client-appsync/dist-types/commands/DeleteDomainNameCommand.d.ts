...
declare const DeleteDomainNameCommand_base: {
    new (input: DeleteDomainNameCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainNameCommandInput, DeleteDomainNameCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDomainNameCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainNameCommandInput, DeleteDomainNameCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
