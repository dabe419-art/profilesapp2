...
declare const DeleteResolverCommand_base: {
    new (input: DeleteResolverCommandInput): import("@smithy/core/client").CommandImpl<DeleteResolverCommandInput, DeleteResolverCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteResolverCommandInput): import("@smithy/core/client").CommandImpl<DeleteResolverCommandInput, DeleteResolverCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
