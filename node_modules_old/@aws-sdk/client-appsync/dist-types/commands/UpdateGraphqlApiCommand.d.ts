...
declare const UpdateGraphqlApiCommand_base: {
    new (input: UpdateGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<UpdateGraphqlApiCommandInput, UpdateGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<UpdateGraphqlApiCommandInput, UpdateGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
