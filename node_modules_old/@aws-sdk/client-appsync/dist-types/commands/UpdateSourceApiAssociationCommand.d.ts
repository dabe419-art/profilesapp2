...
declare const UpdateSourceApiAssociationCommand_base: {
    new (input: UpdateSourceApiAssociationCommandInput): import("@smithy/core/client").CommandImpl<UpdateSourceApiAssociationCommandInput, UpdateSourceApiAssociationCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateSourceApiAssociationCommandInput): import("@smithy/core/client").CommandImpl<UpdateSourceApiAssociationCommandInput, UpdateSourceApiAssociationCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
