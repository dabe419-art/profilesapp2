...
declare const ListEvaluatorsCommand_base: {
    new (input: ListEvaluatorsCommandInput): import("@smithy/core/client").CommandImpl<ListEvaluatorsCommandInput, ListEvaluatorsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEvaluatorsCommandInput]): import("@smithy/core/client").CommandImpl<ListEvaluatorsCommandInput, ListEvaluatorsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
