...
declare const GetEvaluatorCommand_base: {
    new (input: GetEvaluatorCommandInput): import("@smithy/core/client").CommandImpl<GetEvaluatorCommandInput, GetEvaluatorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetEvaluatorCommandInput): import("@smithy/core/client").CommandImpl<GetEvaluatorCommandInput, GetEvaluatorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
