...
declare const CreateRegistryCommand_base: {
    new (input: CreateRegistryCommandInput): import("@smithy/core/client").CommandImpl<CreateRegistryCommandInput, CreateRegistryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRegistryCommandInput): import("@smithy/core/client").CommandImpl<CreateRegistryCommandInput, CreateRegistryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
