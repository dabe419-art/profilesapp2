...
declare const ListBrowsersCommand_base: {
    new (input: ListBrowsersCommandInput): import("@smithy/core/client").CommandImpl<ListBrowsersCommandInput, ListBrowsersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListBrowsersCommandInput]): import("@smithy/core/client").CommandImpl<ListBrowsersCommandInput, ListBrowsersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
