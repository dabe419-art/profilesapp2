...
declare const DeleteHarnessEndpointCommand_base: {
    new (input: DeleteHarnessEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteHarnessEndpointCommandInput, DeleteHarnessEndpointCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteHarnessEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteHarnessEndpointCommandInput, DeleteHarnessEndpointCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
