...
declare const DeleteGatewayRuleCommand_base: {
    new (input: DeleteGatewayRuleCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayRuleCommandInput, DeleteGatewayRuleCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteGatewayRuleCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayRuleCommandInput, DeleteGatewayRuleCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
