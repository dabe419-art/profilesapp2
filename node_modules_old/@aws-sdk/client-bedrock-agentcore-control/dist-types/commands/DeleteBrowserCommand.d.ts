...
declare const DeleteBrowserCommand_base: {
    new (input: DeleteBrowserCommandInput): import("@smithy/core/client").CommandImpl<DeleteBrowserCommandInput, DeleteBrowserCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteBrowserCommandInput): import("@smithy/core/client").CommandImpl<DeleteBrowserCommandInput, DeleteBrowserCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
