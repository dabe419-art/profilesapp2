...
declare const SetTokenVaultCMKCommand_base: {
    new (input: SetTokenVaultCMKCommandInput): import("@smithy/core/client").CommandImpl<SetTokenVaultCMKCommandInput, SetTokenVaultCMKCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetTokenVaultCMKCommandInput): import("@smithy/core/client").CommandImpl<SetTokenVaultCMKCommandInput, SetTokenVaultCMKCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
