...
declare const ListPolicyEngineSummariesCommand_base: {
    new (input: ListPolicyEngineSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyEngineSummariesCommandInput, ListPolicyEngineSummariesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPolicyEngineSummariesCommandInput]): import("@smithy/core/client").CommandImpl<ListPolicyEngineSummariesCommandInput, ListPolicyEngineSummariesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
