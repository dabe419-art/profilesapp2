...
declare const ListAgentRuntimesCommand_base: {
    new (input: ListAgentRuntimesCommandInput): import("@smithy/core/client").CommandImpl<ListAgentRuntimesCommandInput, ListAgentRuntimesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAgentRuntimesCommandInput]): import("@smithy/core/client").CommandImpl<ListAgentRuntimesCommandInput, ListAgentRuntimesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
