...
import type { GetPolicyEngineRequest, GetPolicyEngineResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const GetPolicyEngineCommand_base: {
    new (input: GetPolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyEngineCommandInput, GetPolicyEngineCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyEngineCommandInput, GetPolicyEngineCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
