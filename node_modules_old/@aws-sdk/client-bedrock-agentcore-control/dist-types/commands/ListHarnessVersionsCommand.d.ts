...
declare const ListHarnessVersionsCommand_base: {
    new (input: ListHarnessVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListHarnessVersionsCommandInput, ListHarnessVersionsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListHarnessVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListHarnessVersionsCommandInput, ListHarnessVersionsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
