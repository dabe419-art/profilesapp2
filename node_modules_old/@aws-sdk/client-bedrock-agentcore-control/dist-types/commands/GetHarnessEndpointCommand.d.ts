...
declare const GetHarnessEndpointCommand_base: {
    new (input: GetHarnessEndpointCommandInput): import("@smithy/core/client").CommandImpl<GetHarnessEndpointCommandInput, GetHarnessEndpointCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetHarnessEndpointCommandInput): import("@smithy/core/client").CommandImpl<GetHarnessEndpointCommandInput, GetHarnessEndpointCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
