...
declare const GetCodeInterpreterCommand_base: {
    new (input: GetCodeInterpreterCommandInput): import("@smithy/core/client").CommandImpl<GetCodeInterpreterCommandInput, GetCodeInterpreterCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCodeInterpreterCommandInput): import("@smithy/core/client").CommandImpl<GetCodeInterpreterCommandInput, GetCodeInterpreterCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
