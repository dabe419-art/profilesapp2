...
import type { DeletePolicyEngineRequest, DeletePolicyEngineResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const DeletePolicyEngineCommand_base: {
    new (input: DeletePolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<DeletePolicyEngineCommandInput, DeletePolicyEngineCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<DeletePolicyEngineCommandInput, DeletePolicyEngineCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
