...
declare const GetConfigurationBundleCommand_base: {
    new (input: GetConfigurationBundleCommandInput): import("@smithy/core/client").CommandImpl<GetConfigurationBundleCommandInput, GetConfigurationBundleCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConfigurationBundleCommandInput): import("@smithy/core/client").CommandImpl<GetConfigurationBundleCommandInput, GetConfigurationBundleCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
