...
declare const UpdateHarnessEndpointCommand_base: {
    new (input: UpdateHarnessEndpointCommandInput): import("@smithy/core/client").CommandImpl<UpdateHarnessEndpointCommandInput, UpdateHarnessEndpointCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateHarnessEndpointCommandInput): import("@smithy/core/client").CommandImpl<UpdateHarnessEndpointCommandInput, UpdateHarnessEndpointCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
