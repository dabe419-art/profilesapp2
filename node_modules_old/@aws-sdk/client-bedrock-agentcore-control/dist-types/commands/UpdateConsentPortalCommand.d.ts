...
declare const UpdateConsentPortalCommand_base: {
    new (input: UpdateConsentPortalCommandInput): import("@smithy/core/client").CommandImpl<UpdateConsentPortalCommandInput, UpdateConsentPortalCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateConsentPortalCommandInput): import("@smithy/core/client").CommandImpl<UpdateConsentPortalCommandInput, UpdateConsentPortalCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateConsentPortalCommand extends UpdateConsentPortalCommand_base {
