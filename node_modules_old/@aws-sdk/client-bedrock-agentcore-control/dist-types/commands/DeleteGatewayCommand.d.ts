...
declare const DeleteGatewayCommand_base: {
    new (input: DeleteGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayCommandInput, DeleteGatewayCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayCommandInput, DeleteGatewayCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
