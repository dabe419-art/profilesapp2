...
declare const ListDatasetExamplesCommand_base: {
    new (input: ListDatasetExamplesCommandInput): import("@smithy/core/client").CommandImpl<ListDatasetExamplesCommandInput, ListDatasetExamplesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDatasetExamplesCommandInput): import("@smithy/core/client").CommandImpl<ListDatasetExamplesCommandInput, ListDatasetExamplesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
