...
declare const DeleteConfigurationBundleCommand_base: {
    new (input: DeleteConfigurationBundleCommandInput): import("@smithy/core/client").CommandImpl<DeleteConfigurationBundleCommandInput, DeleteConfigurationBundleCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteConfigurationBundleCommandInput): import("@smithy/core/client").CommandImpl<DeleteConfigurationBundleCommandInput, DeleteConfigurationBundleCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
