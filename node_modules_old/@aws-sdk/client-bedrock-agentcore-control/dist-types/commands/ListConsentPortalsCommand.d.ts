...
declare const ListConsentPortalsCommand_base: {
    new (input: ListConsentPortalsCommandInput): import("@smithy/core/client").CommandImpl<ListConsentPortalsCommandInput, ListConsentPortalsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConsentPortalsCommandInput]): import("@smithy/core/client").CommandImpl<ListConsentPortalsCommandInput, ListConsentPortalsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListConsentPortalsCommand extends ListConsentPortalsCommand_base {
