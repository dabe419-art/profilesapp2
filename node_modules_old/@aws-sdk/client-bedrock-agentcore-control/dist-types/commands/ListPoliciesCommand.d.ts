...
declare const ListPoliciesCommand_base: {
    new (input: ListPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListPoliciesCommandInput, ListPoliciesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListPoliciesCommandInput, ListPoliciesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
