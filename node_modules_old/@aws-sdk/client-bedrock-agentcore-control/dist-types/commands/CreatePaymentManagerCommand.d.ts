...
declare const CreatePaymentManagerCommand_base: {
    new (input: CreatePaymentManagerCommandInput): import("@smithy/core/client").CommandImpl<CreatePaymentManagerCommandInput, CreatePaymentManagerCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePaymentManagerCommandInput): import("@smithy/core/client").CommandImpl<CreatePaymentManagerCommandInput, CreatePaymentManagerCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
