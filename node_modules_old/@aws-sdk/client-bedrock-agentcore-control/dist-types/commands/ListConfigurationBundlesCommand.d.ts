...
declare const ListConfigurationBundlesCommand_base: {
    new (input: ListConfigurationBundlesCommandInput): import("@smithy/core/client").CommandImpl<ListConfigurationBundlesCommandInput, ListConfigurationBundlesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConfigurationBundlesCommandInput]): import("@smithy/core/client").CommandImpl<ListConfigurationBundlesCommandInput, ListConfigurationBundlesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
