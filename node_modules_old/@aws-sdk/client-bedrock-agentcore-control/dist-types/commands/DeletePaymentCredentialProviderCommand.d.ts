...
declare const DeletePaymentCredentialProviderCommand_base: {
    new (input: DeletePaymentCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<DeletePaymentCredentialProviderCommandInput, DeletePaymentCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePaymentCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<DeletePaymentCredentialProviderCommandInput, DeletePaymentCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
