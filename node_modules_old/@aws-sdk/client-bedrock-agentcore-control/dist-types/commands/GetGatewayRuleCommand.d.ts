...
declare const GetGatewayRuleCommand_base: {
    new (input: GetGatewayRuleCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayRuleCommandInput, GetGatewayRuleCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGatewayRuleCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayRuleCommandInput, GetGatewayRuleCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
