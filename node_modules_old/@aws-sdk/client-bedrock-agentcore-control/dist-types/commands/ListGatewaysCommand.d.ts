...
declare const ListGatewaysCommand_base: {
    new (input: ListGatewaysCommandInput): import("@smithy/core/client").CommandImpl<ListGatewaysCommandInput, ListGatewaysCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<ListGatewaysCommandInput, ListGatewaysCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
