...
declare const GetOauth2CredentialProviderCommand_base: {
    new (input: GetOauth2CredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<GetOauth2CredentialProviderCommandInput, GetOauth2CredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOauth2CredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<GetOauth2CredentialProviderCommandInput, GetOauth2CredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
