...
declare const UpdateGatewayCommand_base: {
    new (input: UpdateGatewayCommandInput): import("@smithy/core/client").CommandImpl<UpdateGatewayCommandInput, UpdateGatewayCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateGatewayCommandInput): import("@smithy/core/client").CommandImpl<UpdateGatewayCommandInput, UpdateGatewayCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
