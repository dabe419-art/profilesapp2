...
declare const UpdatePaymentCredentialProviderCommand_base: {
    new (input: UpdatePaymentCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdatePaymentCredentialProviderCommandInput, UpdatePaymentCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePaymentCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdatePaymentCredentialProviderCommandInput, UpdatePaymentCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
