...
declare const UpdateGatewayTargetCommand_base: {
    new (input: UpdateGatewayTargetCommandInput): import("@smithy/core/client").CommandImpl<UpdateGatewayTargetCommandInput, UpdateGatewayTargetCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateGatewayTargetCommandInput): import("@smithy/core/client").CommandImpl<UpdateGatewayTargetCommandInput, UpdateGatewayTargetCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
