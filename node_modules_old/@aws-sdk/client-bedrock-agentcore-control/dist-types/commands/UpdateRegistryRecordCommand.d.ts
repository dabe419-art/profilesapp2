...
declare const UpdateRegistryRecordCommand_base: {
    new (input: UpdateRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<UpdateRegistryRecordCommandInput, UpdateRegistryRecordCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<UpdateRegistryRecordCommandInput, UpdateRegistryRecordCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
