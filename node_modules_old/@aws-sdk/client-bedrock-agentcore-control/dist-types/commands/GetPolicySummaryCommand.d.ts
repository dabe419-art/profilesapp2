...
declare const GetPolicySummaryCommand_base: {
    new (input: GetPolicySummaryCommandInput): import("@smithy/core/client").CommandImpl<GetPolicySummaryCommandInput, GetPolicySummaryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPolicySummaryCommandInput): import("@smithy/core/client").CommandImpl<GetPolicySummaryCommandInput, GetPolicySummaryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetPolicySummaryCommand extends GetPolicySummaryCommand_base {
