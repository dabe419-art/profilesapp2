...
declare const GetGatewayCommand_base: {
    new (input: GetGatewayCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayCommandInput, GetGatewayCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGatewayCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayCommandInput, GetGatewayCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
