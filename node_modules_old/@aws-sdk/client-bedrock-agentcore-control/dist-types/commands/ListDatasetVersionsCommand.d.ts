...
declare const ListDatasetVersionsCommand_base: {
    new (input: ListDatasetVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListDatasetVersionsCommandInput, ListDatasetVersionsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDatasetVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListDatasetVersionsCommandInput, ListDatasetVersionsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
