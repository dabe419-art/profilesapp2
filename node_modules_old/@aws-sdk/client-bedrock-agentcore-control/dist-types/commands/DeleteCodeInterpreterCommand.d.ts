...
declare const DeleteCodeInterpreterCommand_base: {
    new (input: DeleteCodeInterpreterCommandInput): import("@smithy/core/client").CommandImpl<DeleteCodeInterpreterCommandInput, DeleteCodeInterpreterCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCodeInterpreterCommandInput): import("@smithy/core/client").CommandImpl<DeleteCodeInterpreterCommandInput, DeleteCodeInterpreterCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
