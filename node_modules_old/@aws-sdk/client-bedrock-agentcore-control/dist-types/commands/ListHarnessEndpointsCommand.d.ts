...
declare const ListHarnessEndpointsCommand_base: {
    new (input: ListHarnessEndpointsCommandInput): import("@smithy/core/client").CommandImpl<ListHarnessEndpointsCommandInput, ListHarnessEndpointsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListHarnessEndpointsCommandInput): import("@smithy/core/client").CommandImpl<ListHarnessEndpointsCommandInput, ListHarnessEndpointsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
