...
declare const DeleteRegistryRecordCommand_base: {
    new (input: DeleteRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<DeleteRegistryRecordCommandInput, DeleteRegistryRecordCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<DeleteRegistryRecordCommandInput, DeleteRegistryRecordCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
