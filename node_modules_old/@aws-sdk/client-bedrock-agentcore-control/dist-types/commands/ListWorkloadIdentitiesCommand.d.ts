...
declare const ListWorkloadIdentitiesCommand_base: {
    new (input: ListWorkloadIdentitiesCommandInput): import("@smithy/core/client").CommandImpl<ListWorkloadIdentitiesCommandInput, ListWorkloadIdentitiesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListWorkloadIdentitiesCommandInput]): import("@smithy/core/client").CommandImpl<ListWorkloadIdentitiesCommandInput, ListWorkloadIdentitiesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
