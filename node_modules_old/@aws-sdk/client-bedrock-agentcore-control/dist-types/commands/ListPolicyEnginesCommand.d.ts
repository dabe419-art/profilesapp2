...
declare const ListPolicyEnginesCommand_base: {
    new (input: ListPolicyEnginesCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyEnginesCommandInput, ListPolicyEnginesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPolicyEnginesCommandInput]): import("@smithy/core/client").CommandImpl<ListPolicyEnginesCommandInput, ListPolicyEnginesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
