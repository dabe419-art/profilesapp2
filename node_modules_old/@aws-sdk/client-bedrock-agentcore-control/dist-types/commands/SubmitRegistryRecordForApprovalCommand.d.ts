...
declare const SubmitRegistryRecordForApprovalCommand_base: {
    new (input: SubmitRegistryRecordForApprovalCommandInput): import("@smithy/core/client").CommandImpl<SubmitRegistryRecordForApprovalCommandInput, SubmitRegistryRecordForApprovalCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SubmitRegistryRecordForApprovalCommandInput): import("@smithy/core/client").CommandImpl<SubmitRegistryRecordForApprovalCommandInput, SubmitRegistryRecordForApprovalCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
