...
declare const CreateConsentPortalCommand_base: {
    new (input: CreateConsentPortalCommandInput): import("@smithy/core/client").CommandImpl<CreateConsentPortalCommandInput, CreateConsentPortalCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateConsentPortalCommandInput): import("@smithy/core/client").CommandImpl<CreateConsentPortalCommandInput, CreateConsentPortalCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateConsentPortalCommand extends CreateConsentPortalCommand_base {
