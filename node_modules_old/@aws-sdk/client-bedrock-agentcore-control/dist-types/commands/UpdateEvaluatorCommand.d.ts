...
declare const UpdateEvaluatorCommand_base: {
    new (input: UpdateEvaluatorCommandInput): import("@smithy/core/client").CommandImpl<UpdateEvaluatorCommandInput, UpdateEvaluatorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateEvaluatorCommandInput): import("@smithy/core/client").CommandImpl<UpdateEvaluatorCommandInput, UpdateEvaluatorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
