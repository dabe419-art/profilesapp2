...
declare const UpdateMemoryCommand_base: {
    new (input: UpdateMemoryCommandInput): import("@smithy/core/client").CommandImpl<UpdateMemoryCommandInput, UpdateMemoryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMemoryCommandInput): import("@smithy/core/client").CommandImpl<UpdateMemoryCommandInput, UpdateMemoryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
