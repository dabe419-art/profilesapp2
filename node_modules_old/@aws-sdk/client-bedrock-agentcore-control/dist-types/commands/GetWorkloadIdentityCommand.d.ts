...
declare const GetWorkloadIdentityCommand_base: {
    new (input: GetWorkloadIdentityCommandInput): import("@smithy/core/client").CommandImpl<GetWorkloadIdentityCommandInput, GetWorkloadIdentityCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetWorkloadIdentityCommandInput): import("@smithy/core/client").CommandImpl<GetWorkloadIdentityCommandInput, GetWorkloadIdentityCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
