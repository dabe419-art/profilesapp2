...
declare const ListOauth2CredentialProvidersCommand_base: {
    new (input: ListOauth2CredentialProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListOauth2CredentialProvidersCommandInput, ListOauth2CredentialProvidersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListOauth2CredentialProvidersCommandInput]): import("@smithy/core/client").CommandImpl<ListOauth2CredentialProvidersCommandInput, ListOauth2CredentialProvidersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
