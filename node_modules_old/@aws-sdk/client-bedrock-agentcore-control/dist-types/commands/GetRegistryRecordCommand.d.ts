...
declare const GetRegistryRecordCommand_base: {
    new (input: GetRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<GetRegistryRecordCommandInput, GetRegistryRecordCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<GetRegistryRecordCommandInput, GetRegistryRecordCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
