...
declare const GetTokenVaultCommand_base: {
    new (input: GetTokenVaultCommandInput): import("@smithy/core/client").CommandImpl<GetTokenVaultCommandInput, GetTokenVaultCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetTokenVaultCommandInput]): import("@smithy/core/client").CommandImpl<GetTokenVaultCommandInput, GetTokenVaultCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
