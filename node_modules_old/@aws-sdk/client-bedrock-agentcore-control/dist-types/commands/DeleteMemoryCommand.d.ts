...
declare const DeleteMemoryCommand_base: {
    new (input: DeleteMemoryCommandInput): import("@smithy/core/client").CommandImpl<DeleteMemoryCommandInput, DeleteMemoryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMemoryCommandInput): import("@smithy/core/client").CommandImpl<DeleteMemoryCommandInput, DeleteMemoryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
