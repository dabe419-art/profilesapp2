...
declare const UpdatePolicyEngineCommand_base: {
    new (input: UpdatePolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<UpdatePolicyEngineCommandInput, UpdatePolicyEngineCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<UpdatePolicyEngineCommandInput, UpdatePolicyEngineCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
