...
export declare const ConsentPortalSourceType: {
  readonly AGENTCORE_GATEWAY: "agentcore-gateway";
};
export type ConsentPortalSourceType =
  (typeof ConsentPortalSourceType)[keyof typeof ConsentPortalSourceType];
export declare const ConsentPortalStatus: {
  readonly ACTIVE: "ACTIVE";
  readonly CREATING: "CREATING";
  readonly DELETING: "DELETING";
...
export declare const ResultDestination: {
  readonly DEDICATED_LOG_GROUP: "DEDICATED_LOG_GROUP";
  readonly SOURCE_LOG_GROUP: "SOURCE_LOG_GROUP";
};
