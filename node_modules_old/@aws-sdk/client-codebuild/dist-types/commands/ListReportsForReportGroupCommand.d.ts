...
declare const ListReportsForReportGroupCommand_base: {
    new (input: ListReportsForReportGroupCommandInput): import("@smithy/core/client").CommandImpl<ListReportsForReportGroupCommandInput, ListReportsForReportGroupCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListReportsForReportGroupCommandInput): import("@smithy/core/client").CommandImpl<ListReportsForReportGroupCommandInput, ListReportsForReportGroupCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
