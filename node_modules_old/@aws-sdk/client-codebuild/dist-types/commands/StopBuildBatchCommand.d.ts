...
declare const StopBuildBatchCommand_base: {
    new (input: StopBuildBatchCommandInput): import("@smithy/core/client").CommandImpl<StopBuildBatchCommandInput, StopBuildBatchCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopBuildBatchCommandInput): import("@smithy/core/client").CommandImpl<StopBuildBatchCommandInput, StopBuildBatchCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
