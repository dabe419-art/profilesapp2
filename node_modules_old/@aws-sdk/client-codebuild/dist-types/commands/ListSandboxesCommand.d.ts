...
declare const ListSandboxesCommand_base: {
    new (input: ListSandboxesCommandInput): import("@smithy/core/client").CommandImpl<ListSandboxesCommandInput, ListSandboxesCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSandboxesCommandInput]): import("@smithy/core/client").CommandImpl<ListSandboxesCommandInput, ListSandboxesCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
