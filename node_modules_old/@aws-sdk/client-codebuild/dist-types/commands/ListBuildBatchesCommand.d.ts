...
declare const ListBuildBatchesCommand_base: {
    new (input: ListBuildBatchesCommandInput): import("@smithy/core/client").CommandImpl<ListBuildBatchesCommandInput, ListBuildBatchesCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListBuildBatchesCommandInput]): import("@smithy/core/client").CommandImpl<ListBuildBatchesCommandInput, ListBuildBatchesCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
