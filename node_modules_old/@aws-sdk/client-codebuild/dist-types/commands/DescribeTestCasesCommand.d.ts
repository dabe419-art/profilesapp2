...
declare const DescribeTestCasesCommand_base: {
    new (input: DescribeTestCasesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTestCasesCommandInput, DescribeTestCasesCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTestCasesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTestCasesCommandInput, DescribeTestCasesCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
