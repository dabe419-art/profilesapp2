...
declare const ListSandboxesForProjectCommand_base: {
    new (input: ListSandboxesForProjectCommandInput): import("@smithy/core/client").CommandImpl<ListSandboxesForProjectCommandInput, ListSandboxesForProjectCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListSandboxesForProjectCommandInput): import("@smithy/core/client").CommandImpl<ListSandboxesForProjectCommandInput, ListSandboxesForProjectCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
