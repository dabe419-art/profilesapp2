...
declare const ImportSourceCredentialsCommand_base: {
    new (input: ImportSourceCredentialsCommandInput): import("@smithy/core/client").CommandImpl<ImportSourceCredentialsCommandInput, ImportSourceCredentialsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportSourceCredentialsCommandInput): import("@smithy/core/client").CommandImpl<ImportSourceCredentialsCommandInput, ImportSourceCredentialsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
