...
declare const ListReportsCommand_base: {
    new (input: ListReportsCommandInput): import("@smithy/core/client").CommandImpl<ListReportsCommandInput, ListReportsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListReportsCommandInput]): import("@smithy/core/client").CommandImpl<ListReportsCommandInput, ListReportsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
