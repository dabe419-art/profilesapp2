...
declare const ListSharedProjectsCommand_base: {
    new (input: ListSharedProjectsCommandInput): import("@smithy/core/client").CommandImpl<ListSharedProjectsCommandInput, ListSharedProjectsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSharedProjectsCommandInput]): import("@smithy/core/client").CommandImpl<ListSharedProjectsCommandInput, ListSharedProjectsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
