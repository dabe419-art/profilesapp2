...
declare const StartBuildBatchCommand_base: {
    new (input: StartBuildBatchCommandInput): import("@smithy/core/client").CommandImpl<StartBuildBatchCommandInput, StartBuildBatchCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartBuildBatchCommandInput): import("@smithy/core/client").CommandImpl<StartBuildBatchCommandInput, StartBuildBatchCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
