...
declare const ListSourceCredentialsCommand_base: {
    new (input: ListSourceCredentialsCommandInput): import("@smithy/core/client").CommandImpl<ListSourceCredentialsCommandInput, ListSourceCredentialsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSourceCredentialsCommandInput]): import("@smithy/core/client").CommandImpl<ListSourceCredentialsCommandInput, ListSourceCredentialsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
