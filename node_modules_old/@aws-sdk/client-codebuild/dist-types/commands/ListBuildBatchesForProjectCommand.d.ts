...
declare const ListBuildBatchesForProjectCommand_base: {
    new (input: ListBuildBatchesForProjectCommandInput): import("@smithy/core/client").CommandImpl<ListBuildBatchesForProjectCommandInput, ListBuildBatchesForProjectCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListBuildBatchesForProjectCommandInput]): import("@smithy/core/client").CommandImpl<ListBuildBatchesForProjectCommandInput, ListBuildBatchesForProjectCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
