...
declare const DescribeDBProxyTargetsCommand_base: {
    new (input: DescribeDBProxyTargetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBProxyTargetsCommandInput, DescribeDBProxyTargetsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDBProxyTargetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBProxyTargetsCommandInput, DescribeDBProxyTargetsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
