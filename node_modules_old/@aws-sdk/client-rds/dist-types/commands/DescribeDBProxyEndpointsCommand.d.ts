...
declare const DescribeDBProxyEndpointsCommand_base: {
    new (input: DescribeDBProxyEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBProxyEndpointsCommandInput, DescribeDBProxyEndpointsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDBProxyEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDBProxyEndpointsCommandInput, DescribeDBProxyEndpointsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
