...
declare const DescribeEngineDefaultParametersCommand_base: {
    new (input: DescribeEngineDefaultParametersCommandInput): import("@smithy/core/client").CommandImpl<DescribeEngineDefaultParametersCommandInput, DescribeEngineDefaultParametersCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeEngineDefaultParametersCommandInput): import("@smithy/core/client").CommandImpl<DescribeEngineDefaultParametersCommandInput, DescribeEngineDefaultParametersCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
