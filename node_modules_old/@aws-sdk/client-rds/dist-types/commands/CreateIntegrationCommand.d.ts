...
declare const CreateIntegrationCommand_base: {
    new (input: CreateIntegrationCommandInput): import("@smithy/core/client").CommandImpl<CreateIntegrationCommandInput, CreateIntegrationCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIntegrationCommandInput): import("@smithy/core/client").CommandImpl<CreateIntegrationCommandInput, CreateIntegrationCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
