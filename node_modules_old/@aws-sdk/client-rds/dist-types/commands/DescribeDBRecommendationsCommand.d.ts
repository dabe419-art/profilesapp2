...
declare const DescribeDBRecommendationsCommand_base: {
    new (input: DescribeDBRecommendationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBRecommendationsCommandInput, DescribeDBRecommendationsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDBRecommendationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDBRecommendationsCommandInput, DescribeDBRecommendationsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
