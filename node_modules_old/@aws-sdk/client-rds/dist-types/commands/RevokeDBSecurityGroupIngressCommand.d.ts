...
declare const RevokeDBSecurityGroupIngressCommand_base: {
    new (input: RevokeDBSecurityGroupIngressCommandInput): import("@smithy/core/client").CommandImpl<RevokeDBSecurityGroupIngressCommandInput, RevokeDBSecurityGroupIngressCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RevokeDBSecurityGroupIngressCommandInput): import("@smithy/core/client").CommandImpl<RevokeDBSecurityGroupIngressCommandInput, RevokeDBSecurityGroupIngressCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
