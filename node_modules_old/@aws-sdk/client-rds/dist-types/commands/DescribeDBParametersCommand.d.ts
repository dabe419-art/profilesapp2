...
declare const DescribeDBParametersCommand_base: {
    new (input: DescribeDBParametersCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBParametersCommandInput, DescribeDBParametersCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDBParametersCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBParametersCommandInput, DescribeDBParametersCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
