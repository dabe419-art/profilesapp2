...
declare const StopActivityStreamCommand_base: {
    new (input: StopActivityStreamCommandInput): import("@smithy/core/client").CommandImpl<StopActivityStreamCommandInput, StopActivityStreamCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopActivityStreamCommandInput): import("@smithy/core/client").CommandImpl<StopActivityStreamCommandInput, StopActivityStreamCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
