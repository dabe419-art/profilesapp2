...
declare const DescribeDBProxyTargetGroupsCommand_base: {
    new (input: DescribeDBProxyTargetGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBProxyTargetGroupsCommandInput, DescribeDBProxyTargetGroupsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDBProxyTargetGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBProxyTargetGroupsCommandInput, DescribeDBProxyTargetGroupsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
