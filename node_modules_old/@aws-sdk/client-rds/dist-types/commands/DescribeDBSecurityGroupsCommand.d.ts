...
declare const DescribeDBSecurityGroupsCommand_base: {
    new (input: DescribeDBSecurityGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBSecurityGroupsCommandInput, DescribeDBSecurityGroupsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDBSecurityGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDBSecurityGroupsCommandInput, DescribeDBSecurityGroupsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
