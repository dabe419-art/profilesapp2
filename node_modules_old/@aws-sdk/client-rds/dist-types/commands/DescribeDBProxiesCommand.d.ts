...
declare const DescribeDBProxiesCommand_base: {
    new (input: DescribeDBProxiesCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBProxiesCommandInput, DescribeDBProxiesCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDBProxiesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDBProxiesCommandInput, DescribeDBProxiesCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
