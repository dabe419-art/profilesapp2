...
declare const ModifyOptionGroupCommand_base: {
    new (input: ModifyOptionGroupCommandInput): import("@smithy/core/client").CommandImpl<ModifyOptionGroupCommandInput, ModifyOptionGroupCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyOptionGroupCommandInput): import("@smithy/core/client").CommandImpl<ModifyOptionGroupCommandInput, ModifyOptionGroupCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
