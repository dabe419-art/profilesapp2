...
declare const StopDBClusterCommand_base: {
    new (input: StopDBClusterCommandInput): import("@smithy/core/client").CommandImpl<StopDBClusterCommandInput, StopDBClusterCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopDBClusterCommandInput): import("@smithy/core/client").CommandImpl<StopDBClusterCommandInput, StopDBClusterCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
