...
declare const DescribeDBShardGroupsCommand_base: {
    new (input: DescribeDBShardGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBShardGroupsCommandInput, DescribeDBShardGroupsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDBShardGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDBShardGroupsCommandInput, DescribeDBShardGroupsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
