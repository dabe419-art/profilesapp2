...
import type { AdditionalStorageVolume, AvailableProcessorFeature, BlueGreenDeployment, Certificate, DBCluster, DBClusterAssociatedRole, DBClusterSnapshotAttributesResult, DBInstance, DBInstanceAutomatedBackup, DBProxy, DBProxyEndpoint, DBProxyTarget, DBProxyTargetGroup, DBRecommendation, DBSecurityGroup, DBSnapshot, DBSnapshotAttributesResult, DBSubnetGroup, EventSubscription, Filter, GlobalCluster, OptionGroup, OptionSetting, Parameter, ProcessorFeature, RdsCustomClusterConfiguration, ReservedDBInstance, ScalingConfiguration, ServerlessV2ScalingConfiguration, Tag, TagSpecification, TenantDatabase, UserAuthConfig } from "./models_0";
/**
 * <p/>
 * @public
 */
