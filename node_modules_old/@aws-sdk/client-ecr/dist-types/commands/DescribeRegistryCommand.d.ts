...
declare const DescribeRegistryCommand_base: {
    new (input: DescribeRegistryCommandInput): import("@smithy/core/client").CommandImpl<DescribeRegistryCommandInput, DescribeRegistryCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRegistryCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRegistryCommandInput, DescribeRegistryCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
