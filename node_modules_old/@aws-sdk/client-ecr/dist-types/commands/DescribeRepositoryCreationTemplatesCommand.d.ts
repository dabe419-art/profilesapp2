...
declare const DescribeRepositoryCreationTemplatesCommand_base: {
    new (input: DescribeRepositoryCreationTemplatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeRepositoryCreationTemplatesCommandInput, DescribeRepositoryCreationTemplatesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRepositoryCreationTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRepositoryCreationTemplatesCommandInput, DescribeRepositoryCreationTemplatesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
