...
declare const DeletePullThroughCacheRuleCommand_base: {
    new (input: DeletePullThroughCacheRuleCommandInput): import("@smithy/core/client").CommandImpl<DeletePullThroughCacheRuleCommandInput, DeletePullThroughCacheRuleCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePullThroughCacheRuleCommandInput): import("@smithy/core/client").CommandImpl<DeletePullThroughCacheRuleCommandInput, DeletePullThroughCacheRuleCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
