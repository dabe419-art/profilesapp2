...
declare const UpdateRepositoryCreationTemplateCommand_base: {
    new (input: UpdateRepositoryCreationTemplateCommandInput): import("@smithy/core/client").CommandImpl<UpdateRepositoryCreationTemplateCommandInput, UpdateRepositoryCreationTemplateCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRepositoryCreationTemplateCommandInput): import("@smithy/core/client").CommandImpl<UpdateRepositoryCreationTemplateCommandInput, UpdateRepositoryCreationTemplateCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
