...
declare const ListPullTimeUpdateExclusionsCommand_base: {
    new (input: ListPullTimeUpdateExclusionsCommandInput): import("@smithy/core/client").CommandImpl<ListPullTimeUpdateExclusionsCommandInput, ListPullTimeUpdateExclusionsCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPullTimeUpdateExclusionsCommandInput]): import("@smithy/core/client").CommandImpl<ListPullTimeUpdateExclusionsCommandInput, ListPullTimeUpdateExclusionsCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
