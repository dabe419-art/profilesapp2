...
declare const PutImageTagMutabilityCommand_base: {
    new (input: PutImageTagMutabilityCommandInput): import("@smithy/core/client").CommandImpl<PutImageTagMutabilityCommandInput, PutImageTagMutabilityCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutImageTagMutabilityCommandInput): import("@smithy/core/client").CommandImpl<PutImageTagMutabilityCommandInput, PutImageTagMutabilityCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
