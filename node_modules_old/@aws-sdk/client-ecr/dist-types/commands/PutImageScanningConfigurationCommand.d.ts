...
declare const PutImageScanningConfigurationCommand_base: {
    new (input: PutImageScanningConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutImageScanningConfigurationCommandInput, PutImageScanningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutImageScanningConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutImageScanningConfigurationCommandInput, PutImageScanningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
