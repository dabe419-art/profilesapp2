...
declare const GetRegistryScanningConfigurationCommand_base: {
    new (input: GetRegistryScanningConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetRegistryScanningConfigurationCommandInput, GetRegistryScanningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetRegistryScanningConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<GetRegistryScanningConfigurationCommandInput, GetRegistryScanningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
