...
declare const GetRegistryPolicyCommand_base: {
    new (input: GetRegistryPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetRegistryPolicyCommandInput, GetRegistryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetRegistryPolicyCommandInput]): import("@smithy/core/client").CommandImpl<GetRegistryPolicyCommandInput, GetRegistryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
