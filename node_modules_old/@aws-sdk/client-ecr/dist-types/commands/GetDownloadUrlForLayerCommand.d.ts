...
declare const GetDownloadUrlForLayerCommand_base: {
    new (input: GetDownloadUrlForLayerCommandInput): import("@smithy/core/client").CommandImpl<GetDownloadUrlForLayerCommandInput, GetDownloadUrlForLayerCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDownloadUrlForLayerCommandInput): import("@smithy/core/client").CommandImpl<GetDownloadUrlForLayerCommandInput, GetDownloadUrlForLayerCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
