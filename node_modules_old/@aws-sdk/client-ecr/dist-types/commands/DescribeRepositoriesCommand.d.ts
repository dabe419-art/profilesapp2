...
declare const DescribeRepositoriesCommand_base: {
    new (input: DescribeRepositoriesCommandInput): import("@smithy/core/client").CommandImpl<DescribeRepositoriesCommandInput, DescribeRepositoriesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRepositoriesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRepositoriesCommandInput, DescribeRepositoriesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
