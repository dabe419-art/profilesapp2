...
declare const BatchGetRepositoryScanningConfigurationCommand_base: {
    new (input: BatchGetRepositoryScanningConfigurationCommandInput): import("@smithy/core/client").CommandImpl<BatchGetRepositoryScanningConfigurationCommandInput, BatchGetRepositoryScanningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetRepositoryScanningConfigurationCommandInput): import("@smithy/core/client").CommandImpl<BatchGetRepositoryScanningConfigurationCommandInput, BatchGetRepositoryScanningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
