...
declare const RegisterPullTimeUpdateExclusionCommand_base: {
    new (input: RegisterPullTimeUpdateExclusionCommandInput): import("@smithy/core/client").CommandImpl<RegisterPullTimeUpdateExclusionCommandInput, RegisterPullTimeUpdateExclusionCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterPullTimeUpdateExclusionCommandInput): import("@smithy/core/client").CommandImpl<RegisterPullTimeUpdateExclusionCommandInput, RegisterPullTimeUpdateExclusionCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
