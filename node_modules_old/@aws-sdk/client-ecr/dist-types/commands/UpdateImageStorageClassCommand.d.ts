...
declare const UpdateImageStorageClassCommand_base: {
    new (input: UpdateImageStorageClassCommandInput): import("@smithy/core/client").CommandImpl<UpdateImageStorageClassCommandInput, UpdateImageStorageClassCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateImageStorageClassCommandInput): import("@smithy/core/client").CommandImpl<UpdateImageStorageClassCommandInput, UpdateImageStorageClassCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
