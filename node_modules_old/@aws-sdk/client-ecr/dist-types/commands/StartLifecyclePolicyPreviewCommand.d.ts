...
declare const StartLifecyclePolicyPreviewCommand_base: {
    new (input: StartLifecyclePolicyPreviewCommandInput): import("@smithy/core/client").CommandImpl<StartLifecyclePolicyPreviewCommandInput, StartLifecyclePolicyPreviewCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartLifecyclePolicyPreviewCommandInput): import("@smithy/core/client").CommandImpl<StartLifecyclePolicyPreviewCommandInput, StartLifecyclePolicyPreviewCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
