...
declare const PutLifecyclePolicyCommand_base: {
    new (input: PutLifecyclePolicyCommandInput): import("@smithy/core/client").CommandImpl<PutLifecyclePolicyCommandInput, PutLifecyclePolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutLifecyclePolicyCommandInput): import("@smithy/core/client").CommandImpl<PutLifecyclePolicyCommandInput, PutLifecyclePolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
