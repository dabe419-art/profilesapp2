...
declare const DeleteSigningConfigurationCommand_base: {
    new (input: DeleteSigningConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSigningConfigurationCommandInput, DeleteSigningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteSigningConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<DeleteSigningConfigurationCommandInput, DeleteSigningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
