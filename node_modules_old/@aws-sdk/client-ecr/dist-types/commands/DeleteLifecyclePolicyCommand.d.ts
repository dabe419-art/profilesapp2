...
declare const DeleteLifecyclePolicyCommand_base: {
    new (input: DeleteLifecyclePolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteLifecyclePolicyCommandInput, DeleteLifecyclePolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLifecyclePolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteLifecyclePolicyCommandInput, DeleteLifecyclePolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
