...
declare const CompleteLayerUploadCommand_base: {
    new (input: CompleteLayerUploadCommandInput): import("@smithy/core/client").CommandImpl<CompleteLayerUploadCommandInput, CompleteLayerUploadCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CompleteLayerUploadCommandInput): import("@smithy/core/client").CommandImpl<CompleteLayerUploadCommandInput, CompleteLayerUploadCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
