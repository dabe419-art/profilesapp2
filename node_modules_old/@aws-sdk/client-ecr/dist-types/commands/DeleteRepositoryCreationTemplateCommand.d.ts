...
declare const DeleteRepositoryCreationTemplateCommand_base: {
    new (input: DeleteRepositoryCreationTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteRepositoryCreationTemplateCommandInput, DeleteRepositoryCreationTemplateCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRepositoryCreationTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteRepositoryCreationTemplateCommandInput, DeleteRepositoryCreationTemplateCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
