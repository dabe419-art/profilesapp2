...
declare const PutImageCommand_base: {
    new (input: PutImageCommandInput): import("@smithy/core/client").CommandImpl<PutImageCommandInput, PutImageCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutImageCommandInput): import("@smithy/core/client").CommandImpl<PutImageCommandInput, PutImageCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
