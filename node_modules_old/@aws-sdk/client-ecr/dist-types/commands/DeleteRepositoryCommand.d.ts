...
declare const DeleteRepositoryCommand_base: {
    new (input: DeleteRepositoryCommandInput): import("@smithy/core/client").CommandImpl<DeleteRepositoryCommandInput, DeleteRepositoryCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRepositoryCommandInput): import("@smithy/core/client").CommandImpl<DeleteRepositoryCommandInput, DeleteRepositoryCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
