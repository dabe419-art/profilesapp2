...
declare const DescribeImageReplicationStatusCommand_base: {
    new (input: DescribeImageReplicationStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageReplicationStatusCommandInput, DescribeImageReplicationStatusCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImageReplicationStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageReplicationStatusCommandInput, DescribeImageReplicationStatusCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
