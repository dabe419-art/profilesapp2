...
declare const GetAuthorizationTokenCommand_base: {
    new (input: GetAuthorizationTokenCommandInput): import("@smithy/core/client").CommandImpl<GetAuthorizationTokenCommandInput, GetAuthorizationTokenCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAuthorizationTokenCommandInput]): import("@smithy/core/client").CommandImpl<GetAuthorizationTokenCommandInput, GetAuthorizationTokenCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
