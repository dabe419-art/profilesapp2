...
declare const DeregisterPullTimeUpdateExclusionCommand_base: {
    new (input: DeregisterPullTimeUpdateExclusionCommandInput): import("@smithy/core/client").CommandImpl<DeregisterPullTimeUpdateExclusionCommandInput, DeregisterPullTimeUpdateExclusionCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeregisterPullTimeUpdateExclusionCommandInput): import("@smithy/core/client").CommandImpl<DeregisterPullTimeUpdateExclusionCommandInput, DeregisterPullTimeUpdateExclusionCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
