...
declare const CreateRepositoryCommand_base: {
    new (input: CreateRepositoryCommandInput): import("@smithy/core/client").CommandImpl<CreateRepositoryCommandInput, CreateRepositoryCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRepositoryCommandInput): import("@smithy/core/client").CommandImpl<CreateRepositoryCommandInput, CreateRepositoryCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
