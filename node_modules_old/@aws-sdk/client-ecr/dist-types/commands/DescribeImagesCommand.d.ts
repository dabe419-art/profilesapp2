...
declare const DescribeImagesCommand_base: {
    new (input: DescribeImagesCommandInput): import("@smithy/core/client").CommandImpl<DescribeImagesCommandInput, DescribeImagesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImagesCommandInput): import("@smithy/core/client").CommandImpl<DescribeImagesCommandInput, DescribeImagesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
