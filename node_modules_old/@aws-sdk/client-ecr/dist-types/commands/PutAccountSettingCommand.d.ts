...
declare const PutAccountSettingCommand_base: {
    new (input: PutAccountSettingCommandInput): import("@smithy/core/client").CommandImpl<PutAccountSettingCommandInput, PutAccountSettingCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutAccountSettingCommandInput): import("@smithy/core/client").CommandImpl<PutAccountSettingCommandInput, PutAccountSettingCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
