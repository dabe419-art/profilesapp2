...
declare const GetLifecyclePolicyPreviewCommand_base: {
    new (input: GetLifecyclePolicyPreviewCommandInput): import("@smithy/core/client").CommandImpl<GetLifecyclePolicyPreviewCommandInput, GetLifecyclePolicyPreviewCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLifecyclePolicyPreviewCommandInput): import("@smithy/core/client").CommandImpl<GetLifecyclePolicyPreviewCommandInput, GetLifecyclePolicyPreviewCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
