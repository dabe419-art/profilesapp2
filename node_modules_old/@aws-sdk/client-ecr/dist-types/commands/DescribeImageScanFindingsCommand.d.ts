...
declare const DescribeImageScanFindingsCommand_base: {
    new (input: DescribeImageScanFindingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageScanFindingsCommandInput, DescribeImageScanFindingsCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImageScanFindingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageScanFindingsCommandInput, DescribeImageScanFindingsCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
