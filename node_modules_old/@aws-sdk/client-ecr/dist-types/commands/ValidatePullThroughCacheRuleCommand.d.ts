...
declare const ValidatePullThroughCacheRuleCommand_base: {
    new (input: ValidatePullThroughCacheRuleCommandInput): import("@smithy/core/client").CommandImpl<ValidatePullThroughCacheRuleCommandInput, ValidatePullThroughCacheRuleCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ValidatePullThroughCacheRuleCommandInput): import("@smithy/core/client").CommandImpl<ValidatePullThroughCacheRuleCommandInput, ValidatePullThroughCacheRuleCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
