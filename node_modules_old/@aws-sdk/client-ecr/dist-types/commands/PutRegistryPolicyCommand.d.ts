...
declare const PutRegistryPolicyCommand_base: {
    new (input: PutRegistryPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutRegistryPolicyCommandInput, PutRegistryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRegistryPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutRegistryPolicyCommandInput, PutRegistryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
