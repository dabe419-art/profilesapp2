...
declare const SetRulePrioritiesCommand_base: {
    new (input: SetRulePrioritiesCommandInput): import("@smithy/core/client").CommandImpl<SetRulePrioritiesCommandInput, SetRulePrioritiesCommandOutput, import("..").ElasticLoadBalancingV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetRulePrioritiesCommandInput): import("@smithy/core/client").CommandImpl<SetRulePrioritiesCommandInput, SetRulePrioritiesCommandOutput, import("..").ElasticLoadBalancingV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
