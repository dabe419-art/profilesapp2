...
export declare class TooManyTrustStoreRevocationEntriesException extends __BaseException {
  ...
  Message?: string | undefined;
  constructor(
    opts: __ExceptionOptionType<TooManyTrustStoreRevocationEntriesException, __BaseException>,
  );
}
...
export declare class CapacityDecreaseRequestsLimitExceededException extends __BaseException {
  ...
  Message?: string | undefined;
  constructor(
    opts: __ExceptionOptionType<CapacityDecreaseRequestsLimitExceededException, __BaseException>,
  );
}
...
export declare class TooManyRegistrationsForTargetIdException extends __BaseException {
  ...
  Message?: string | undefined;
  constructor(
    opts: __ExceptionOptionType<TooManyRegistrationsForTargetIdException, __BaseException>,
  );
}
...
export declare class TooManyUniqueTargetGroupsPerLoadBalancerException extends __BaseException {
  ...
  Message?: string | undefined;
  constructor(
    opts: __ExceptionOptionType<TooManyUniqueTargetGroupsPerLoadBalancerException, __BaseException>,
  );
}
