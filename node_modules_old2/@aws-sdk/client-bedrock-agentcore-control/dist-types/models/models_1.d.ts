...
import type { ActorTokenContentType, ClientAuthenticationMethodType, ClusteringFrequency, ContentLevel, ContentType, CredentialProviderType, CredentialProviderVendorType, ExtractionType, FilterOperator, HarnessBedrockApiFormat, HarnessEndpointStatus, HarnessManagedMemoryStrategyType, HarnessOpenAiApiFormat, HarnessStatus, HarnessToolType, HarnessTruncationStrategy, KeyType, ListingMode, MemoryStatus, MemoryStrategyStatus, MemoryStrategyType, MemoryView, MetadataValueType, OnBehalfOfTokenExchangeGrantTypeType, OnlineEvaluationConfigStatus, OnlineEvaluationExecutionStatus, OverrideType, PassthroughProtocolType, PaymentConnectorProvisionMode, PaymentConnectorStatus, PaymentConnectorType, PaymentCredentialProviderVendorType, PaymentManagerStatus, PaymentsAuthorizerType, RestApiMethod, ResultDestination, SecretSourceType, SigningAlgorithm, StaticQueryParameterConflictResolution, Status, TargetStatus, TargetType } from "./enums";
import type { AuthorizerConfiguration, ContainerConfiguration, FilesystemConfiguration, GatewayApiKeyCredentialProvider, IamCredentialProvider, LifecycleConfiguration, NetworkConfiguration, OAuthCredentialProvider, PrivateEndpoint, PrivateEndpointOverride, Secret, SecretReference, Unit, WorkloadIdentityDetails } from "./models_0";
/**
 ...
 * @public
 */
export type HarnessEnvironmentProviderRequest = HarnessEnvironmentProviderRequest.AgentCoreRuntimeEnvironmentMember | HarnessEnvironmentProviderRequest.$UnknownMember;
/**
 * @public
 */
 ...
 * @public
 */
export type HarnessEnvironmentArtifact = HarnessEnvironmentArtifact.ContainerConfigurationMember | HarnessEnvironmentArtifact.$UnknownMember;
/**
 * @public
 */
