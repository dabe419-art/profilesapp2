...
declare const GetBrowserProfileCommand_base: {
    new (input: GetBrowserProfileCommandInput): import("@smithy/core/client").CommandImpl<GetBrowserProfileCommandInput, GetBrowserProfileCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBrowserProfileCommandInput): import("@smithy/core/client").CommandImpl<GetBrowserProfileCommandInput, GetBrowserProfileCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
