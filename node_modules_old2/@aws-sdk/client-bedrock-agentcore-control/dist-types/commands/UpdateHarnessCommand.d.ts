...
declare const UpdateHarnessCommand_base: {
    new (input: UpdateHarnessCommandInput): import("@smithy/core/client").CommandImpl<UpdateHarnessCommandInput, UpdateHarnessCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateHarnessCommandInput): import("@smithy/core/client").CommandImpl<UpdateHarnessCommandInput, UpdateHarnessCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
