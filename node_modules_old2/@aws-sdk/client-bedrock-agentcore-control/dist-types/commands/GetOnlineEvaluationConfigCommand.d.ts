...
declare const GetOnlineEvaluationConfigCommand_base: {
    new (input: GetOnlineEvaluationConfigCommandInput): import("@smithy/core/client").CommandImpl<GetOnlineEvaluationConfigCommandInput, GetOnlineEvaluationConfigCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOnlineEvaluationConfigCommandInput): import("@smithy/core/client").CommandImpl<GetOnlineEvaluationConfigCommandInput, GetOnlineEvaluationConfigCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
