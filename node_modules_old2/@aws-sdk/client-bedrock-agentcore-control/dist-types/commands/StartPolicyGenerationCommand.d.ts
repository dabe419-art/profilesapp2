...
declare const StartPolicyGenerationCommand_base: {
    new (input: StartPolicyGenerationCommandInput): import("@smithy/core/client").CommandImpl<StartPolicyGenerationCommandInput, StartPolicyGenerationCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartPolicyGenerationCommandInput): import("@smithy/core/client").CommandImpl<StartPolicyGenerationCommandInput, StartPolicyGenerationCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
