...
declare const UpdateWorkloadIdentityCommand_base: {
    new (input: UpdateWorkloadIdentityCommandInput): import("@smithy/core/client").CommandImpl<UpdateWorkloadIdentityCommandInput, UpdateWorkloadIdentityCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateWorkloadIdentityCommandInput): import("@smithy/core/client").CommandImpl<UpdateWorkloadIdentityCommandInput, UpdateWorkloadIdentityCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
