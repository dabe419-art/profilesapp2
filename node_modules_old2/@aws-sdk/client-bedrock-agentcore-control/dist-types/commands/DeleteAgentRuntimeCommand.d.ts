...
declare const DeleteAgentRuntimeCommand_base: {
    new (input: DeleteAgentRuntimeCommandInput): import("@smithy/core/client").CommandImpl<DeleteAgentRuntimeCommandInput, DeleteAgentRuntimeCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAgentRuntimeCommandInput): import("@smithy/core/client").CommandImpl<DeleteAgentRuntimeCommandInput, DeleteAgentRuntimeCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
