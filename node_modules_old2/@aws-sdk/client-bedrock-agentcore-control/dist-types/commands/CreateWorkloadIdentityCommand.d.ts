...
declare const CreateWorkloadIdentityCommand_base: {
    new (input: CreateWorkloadIdentityCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkloadIdentityCommandInput, CreateWorkloadIdentityCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateWorkloadIdentityCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkloadIdentityCommandInput, CreateWorkloadIdentityCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
