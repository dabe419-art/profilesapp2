...
declare const DeleteWorkloadIdentityCommand_base: {
    new (input: DeleteWorkloadIdentityCommandInput): import("@smithy/core/client").CommandImpl<DeleteWorkloadIdentityCommandInput, DeleteWorkloadIdentityCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteWorkloadIdentityCommandInput): import("@smithy/core/client").CommandImpl<DeleteWorkloadIdentityCommandInput, DeleteWorkloadIdentityCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
