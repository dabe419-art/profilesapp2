...
declare const ListApiKeyCredentialProvidersCommand_base: {
    new (input: ListApiKeyCredentialProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListApiKeyCredentialProvidersCommandInput, ListApiKeyCredentialProvidersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListApiKeyCredentialProvidersCommandInput]): import("@smithy/core/client").CommandImpl<ListApiKeyCredentialProvidersCommandInput, ListApiKeyCredentialProvidersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
