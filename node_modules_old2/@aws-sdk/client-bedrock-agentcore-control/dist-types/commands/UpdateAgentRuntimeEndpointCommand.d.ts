...
declare const UpdateAgentRuntimeEndpointCommand_base: {
    new (input: UpdateAgentRuntimeEndpointCommandInput): import("@smithy/core/client").CommandImpl<UpdateAgentRuntimeEndpointCommandInput, UpdateAgentRuntimeEndpointCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAgentRuntimeEndpointCommandInput): import("@smithy/core/client").CommandImpl<UpdateAgentRuntimeEndpointCommandInput, UpdateAgentRuntimeEndpointCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
