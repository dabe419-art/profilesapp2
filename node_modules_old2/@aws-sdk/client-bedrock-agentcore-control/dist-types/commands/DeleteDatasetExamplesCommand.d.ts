...
declare const DeleteDatasetExamplesCommand_base: {
    new (input: DeleteDatasetExamplesCommandInput): import("@smithy/core/client").CommandImpl<DeleteDatasetExamplesCommandInput, DeleteDatasetExamplesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDatasetExamplesCommandInput): import("@smithy/core/client").CommandImpl<DeleteDatasetExamplesCommandInput, DeleteDatasetExamplesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
