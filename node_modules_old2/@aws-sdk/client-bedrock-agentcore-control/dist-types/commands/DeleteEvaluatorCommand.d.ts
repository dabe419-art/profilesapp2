...
declare const DeleteEvaluatorCommand_base: {
    new (input: DeleteEvaluatorCommandInput): import("@smithy/core/client").CommandImpl<DeleteEvaluatorCommandInput, DeleteEvaluatorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteEvaluatorCommandInput): import("@smithy/core/client").CommandImpl<DeleteEvaluatorCommandInput, DeleteEvaluatorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
