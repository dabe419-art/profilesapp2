...
declare const ListPaymentCredentialProvidersCommand_base: {
    new (input: ListPaymentCredentialProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListPaymentCredentialProvidersCommandInput, ListPaymentCredentialProvidersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPaymentCredentialProvidersCommandInput]): import("@smithy/core/client").CommandImpl<ListPaymentCredentialProvidersCommandInput, ListPaymentCredentialProvidersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
