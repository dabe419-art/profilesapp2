...
declare const GetPolicyEngineSummaryCommand_base: {
    new (input: GetPolicyEngineSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyEngineSummaryCommandInput, GetPolicyEngineSummaryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPolicyEngineSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyEngineSummaryCommandInput, GetPolicyEngineSummaryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetPolicyEngineSummaryCommand extends GetPolicyEngineSummaryCommand_base {
