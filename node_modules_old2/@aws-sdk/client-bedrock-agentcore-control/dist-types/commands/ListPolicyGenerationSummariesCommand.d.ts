...
declare const ListPolicyGenerationSummariesCommand_base: {
    new (input: ListPolicyGenerationSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyGenerationSummariesCommandInput, ListPolicyGenerationSummariesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPolicyGenerationSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyGenerationSummariesCommandInput, ListPolicyGenerationSummariesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
