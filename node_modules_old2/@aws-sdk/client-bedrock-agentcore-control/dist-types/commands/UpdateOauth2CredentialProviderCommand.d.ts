...
declare const UpdateOauth2CredentialProviderCommand_base: {
    new (input: UpdateOauth2CredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateOauth2CredentialProviderCommandInput, UpdateOauth2CredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateOauth2CredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateOauth2CredentialProviderCommandInput, UpdateOauth2CredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
