...
declare const UpdateRegistryCommand_base: {
    new (input: UpdateRegistryCommandInput): import("@smithy/core/client").CommandImpl<UpdateRegistryCommandInput, UpdateRegistryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRegistryCommandInput): import("@smithy/core/client").CommandImpl<UpdateRegistryCommandInput, UpdateRegistryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
