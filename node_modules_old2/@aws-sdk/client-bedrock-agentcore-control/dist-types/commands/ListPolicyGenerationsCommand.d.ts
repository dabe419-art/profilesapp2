...
declare const ListPolicyGenerationsCommand_base: {
    new (input: ListPolicyGenerationsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyGenerationsCommandInput, ListPolicyGenerationsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPolicyGenerationsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyGenerationsCommandInput, ListPolicyGenerationsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
