...
declare const GetRegistryCommand_base: {
    new (input: GetRegistryCommandInput): import("@smithy/core/client").CommandImpl<GetRegistryCommandInput, GetRegistryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRegistryCommandInput): import("@smithy/core/client").CommandImpl<GetRegistryCommandInput, GetRegistryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
