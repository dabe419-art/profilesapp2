...
declare const UpdatePolicyCommand_base: {
    new (input: UpdatePolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdatePolicyCommandInput, UpdatePolicyCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdatePolicyCommandInput, UpdatePolicyCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
