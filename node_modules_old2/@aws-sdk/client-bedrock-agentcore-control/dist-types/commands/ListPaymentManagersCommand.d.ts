...
declare const ListPaymentManagersCommand_base: {
    new (input: ListPaymentManagersCommandInput): import("@smithy/core/client").CommandImpl<ListPaymentManagersCommandInput, ListPaymentManagersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPaymentManagersCommandInput]): import("@smithy/core/client").CommandImpl<ListPaymentManagersCommandInput, ListPaymentManagersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
