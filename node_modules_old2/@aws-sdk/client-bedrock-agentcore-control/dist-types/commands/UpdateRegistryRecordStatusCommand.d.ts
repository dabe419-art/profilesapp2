...
declare const UpdateRegistryRecordStatusCommand_base: {
    new (input: UpdateRegistryRecordStatusCommandInput): import("@smithy/core/client").CommandImpl<UpdateRegistryRecordStatusCommandInput, UpdateRegistryRecordStatusCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRegistryRecordStatusCommandInput): import("@smithy/core/client").CommandImpl<UpdateRegistryRecordStatusCommandInput, UpdateRegistryRecordStatusCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
