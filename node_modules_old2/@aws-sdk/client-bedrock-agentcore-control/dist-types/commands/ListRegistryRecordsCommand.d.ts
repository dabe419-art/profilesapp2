...
declare const ListRegistryRecordsCommand_base: {
    new (input: ListRegistryRecordsCommandInput): import("@smithy/core/client").CommandImpl<ListRegistryRecordsCommandInput, ListRegistryRecordsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListRegistryRecordsCommandInput): import("@smithy/core/client").CommandImpl<ListRegistryRecordsCommandInput, ListRegistryRecordsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
