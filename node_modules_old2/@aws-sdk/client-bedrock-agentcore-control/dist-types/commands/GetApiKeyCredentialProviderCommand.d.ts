...
declare const GetApiKeyCredentialProviderCommand_base: {
    new (input: GetApiKeyCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<GetApiKeyCredentialProviderCommandInput, GetApiKeyCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetApiKeyCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<GetApiKeyCredentialProviderCommandInput, GetApiKeyCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
