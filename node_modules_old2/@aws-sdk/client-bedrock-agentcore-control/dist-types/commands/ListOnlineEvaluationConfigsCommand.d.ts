...
declare const ListOnlineEvaluationConfigsCommand_base: {
    new (input: ListOnlineEvaluationConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListOnlineEvaluationConfigsCommandInput, ListOnlineEvaluationConfigsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListOnlineEvaluationConfigsCommandInput]): import("@smithy/core/client").CommandImpl<ListOnlineEvaluationConfigsCommandInput, ListOnlineEvaluationConfigsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
