...
declare const DeletePaymentManagerCommand_base: {
    new (input: DeletePaymentManagerCommandInput): import("@smithy/core/client").CommandImpl<DeletePaymentManagerCommandInput, DeletePaymentManagerCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePaymentManagerCommandInput): import("@smithy/core/client").CommandImpl<DeletePaymentManagerCommandInput, DeletePaymentManagerCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
