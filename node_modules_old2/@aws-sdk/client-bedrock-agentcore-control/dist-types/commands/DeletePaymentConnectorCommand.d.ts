...
declare const DeletePaymentConnectorCommand_base: {
    new (input: DeletePaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<DeletePaymentConnectorCommandInput, DeletePaymentConnectorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<DeletePaymentConnectorCommandInput, DeletePaymentConnectorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
