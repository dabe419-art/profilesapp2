...
declare const GetMemoryCommand_base: {
    new (input: GetMemoryCommandInput): import("@smithy/core/client").CommandImpl<GetMemoryCommandInput, GetMemoryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMemoryCommandInput): import("@smithy/core/client").CommandImpl<GetMemoryCommandInput, GetMemoryCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
