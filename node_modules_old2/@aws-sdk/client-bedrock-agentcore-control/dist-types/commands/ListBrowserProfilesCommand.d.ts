...
declare const ListBrowserProfilesCommand_base: {
    new (input: ListBrowserProfilesCommandInput): import("@smithy/core/client").CommandImpl<ListBrowserProfilesCommandInput, ListBrowserProfilesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListBrowserProfilesCommandInput]): import("@smithy/core/client").CommandImpl<ListBrowserProfilesCommandInput, ListBrowserProfilesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
