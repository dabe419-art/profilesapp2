...
declare const ListGatewayTargetsCommand_base: {
    new (input: ListGatewayTargetsCommandInput): import("@smithy/core/client").CommandImpl<ListGatewayTargetsCommandInput, ListGatewayTargetsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListGatewayTargetsCommandInput): import("@smithy/core/client").CommandImpl<ListGatewayTargetsCommandInput, ListGatewayTargetsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
