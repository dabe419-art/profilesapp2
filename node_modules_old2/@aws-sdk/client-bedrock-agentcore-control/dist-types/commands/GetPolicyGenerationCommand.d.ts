...
declare const GetPolicyGenerationCommand_base: {
    new (input: GetPolicyGenerationCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyGenerationCommandInput, GetPolicyGenerationCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPolicyGenerationCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyGenerationCommandInput, GetPolicyGenerationCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
