...
declare const ListPaymentConnectorsCommand_base: {
    new (input: ListPaymentConnectorsCommandInput): import("@smithy/core/client").CommandImpl<ListPaymentConnectorsCommandInput, ListPaymentConnectorsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPaymentConnectorsCommandInput): import("@smithy/core/client").CommandImpl<ListPaymentConnectorsCommandInput, ListPaymentConnectorsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
