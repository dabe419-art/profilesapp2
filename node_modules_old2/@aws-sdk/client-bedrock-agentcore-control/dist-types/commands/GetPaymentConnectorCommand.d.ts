...
declare const GetPaymentConnectorCommand_base: {
    new (input: GetPaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentConnectorCommandInput, GetPaymentConnectorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentConnectorCommandInput, GetPaymentConnectorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
