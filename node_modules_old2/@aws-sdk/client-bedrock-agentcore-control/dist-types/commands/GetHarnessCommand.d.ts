...
declare const GetHarnessCommand_base: {
    new (input: GetHarnessCommandInput): import("@smithy/core/client").CommandImpl<GetHarnessCommandInput, GetHarnessCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetHarnessCommandInput): import("@smithy/core/client").CommandImpl<GetHarnessCommandInput, GetHarnessCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
