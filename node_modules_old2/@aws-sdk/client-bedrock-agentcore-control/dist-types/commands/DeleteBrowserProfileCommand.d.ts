...
declare const DeleteBrowserProfileCommand_base: {
    new (input: DeleteBrowserProfileCommandInput): import("@smithy/core/client").CommandImpl<DeleteBrowserProfileCommandInput, DeleteBrowserProfileCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteBrowserProfileCommandInput): import("@smithy/core/client").CommandImpl<DeleteBrowserProfileCommandInput, DeleteBrowserProfileCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
