...
declare const ListRegistriesCommand_base: {
    new (input: ListRegistriesCommandInput): import("@smithy/core/client").CommandImpl<ListRegistriesCommandInput, ListRegistriesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListRegistriesCommandInput]): import("@smithy/core/client").CommandImpl<ListRegistriesCommandInput, ListRegistriesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
