...
declare const GetPaymentManagerCommand_base: {
    new (input: GetPaymentManagerCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentManagerCommandInput, GetPaymentManagerCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPaymentManagerCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentManagerCommandInput, GetPaymentManagerCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
