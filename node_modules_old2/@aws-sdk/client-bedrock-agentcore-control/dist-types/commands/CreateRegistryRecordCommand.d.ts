...
import type { CreateRegistryRecordRequest, CreateRegistryRecordResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateRegistryRecordCommand_base: {
    new (input: CreateRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<CreateRegistryRecordCommandInput, CreateRegistryRecordCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<CreateRegistryRecordCommandInput, CreateRegistryRecordCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
