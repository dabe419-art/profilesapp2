...
declare const GetConsentPortalCommand_base: {
    new (input: GetConsentPortalCommandInput): import("@smithy/core/client").CommandImpl<GetConsentPortalCommandInput, GetConsentPortalCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConsentPortalCommandInput): import("@smithy/core/client").CommandImpl<GetConsentPortalCommandInput, GetConsentPortalCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetConsentPortalCommand extends GetConsentPortalCommand_base {
