...
declare const ListHarnessesCommand_base: {
    new (input: ListHarnessesCommandInput): import("@smithy/core/client").CommandImpl<ListHarnessesCommandInput, ListHarnessesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListHarnessesCommandInput]): import("@smithy/core/client").CommandImpl<ListHarnessesCommandInput, ListHarnessesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
