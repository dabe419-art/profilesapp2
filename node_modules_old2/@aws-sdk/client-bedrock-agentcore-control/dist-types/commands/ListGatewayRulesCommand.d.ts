...
declare const ListGatewayRulesCommand_base: {
    new (input: ListGatewayRulesCommandInput): import("@smithy/core/client").CommandImpl<ListGatewayRulesCommandInput, ListGatewayRulesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListGatewayRulesCommandInput): import("@smithy/core/client").CommandImpl<ListGatewayRulesCommandInput, ListGatewayRulesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
