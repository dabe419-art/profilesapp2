...
declare const GetPaymentCredentialProviderCommand_base: {
    new (input: GetPaymentCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentCredentialProviderCommandInput, GetPaymentCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPaymentCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentCredentialProviderCommandInput, GetPaymentCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
