...
declare const DeleteHarnessCommand_base: {
    new (input: DeleteHarnessCommandInput): import("@smithy/core/client").CommandImpl<DeleteHarnessCommandInput, DeleteHarnessCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteHarnessCommandInput): import("@smithy/core/client").CommandImpl<DeleteHarnessCommandInput, DeleteHarnessCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
