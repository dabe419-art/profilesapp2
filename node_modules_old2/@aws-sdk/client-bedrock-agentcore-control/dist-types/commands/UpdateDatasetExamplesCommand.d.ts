...
declare const UpdateDatasetExamplesCommand_base: {
    new (input: UpdateDatasetExamplesCommandInput): import("@smithy/core/client").CommandImpl<UpdateDatasetExamplesCommandInput, UpdateDatasetExamplesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDatasetExamplesCommandInput): import("@smithy/core/client").CommandImpl<UpdateDatasetExamplesCommandInput, UpdateDatasetExamplesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
