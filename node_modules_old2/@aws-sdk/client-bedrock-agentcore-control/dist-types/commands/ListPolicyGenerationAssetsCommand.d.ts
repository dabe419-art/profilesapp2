...
declare const ListPolicyGenerationAssetsCommand_base: {
    new (input: ListPolicyGenerationAssetsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyGenerationAssetsCommandInput, ListPolicyGenerationAssetsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPolicyGenerationAssetsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyGenerationAssetsCommandInput, ListPolicyGenerationAssetsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
