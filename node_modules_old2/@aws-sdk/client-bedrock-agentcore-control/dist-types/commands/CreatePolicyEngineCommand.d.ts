...
import type { CreatePolicyEngineRequest } from "../models/models_1";
import type { CreatePolicyEngineResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const CreatePolicyEngineCommand_base: {
    new (input: CreatePolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<CreatePolicyEngineCommandInput, CreatePolicyEngineCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<CreatePolicyEngineCommandInput, CreatePolicyEngineCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
