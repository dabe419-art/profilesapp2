...
declare const CreatePaymentCredentialProviderCommand_base: {
    new (input: CreatePaymentCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<CreatePaymentCredentialProviderCommandInput, CreatePaymentCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePaymentCredentialProviderCommandInput): import("@smithy/core/client").CommandImpl<CreatePaymentCredentialProviderCommandInput, CreatePaymentCredentialProviderCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
