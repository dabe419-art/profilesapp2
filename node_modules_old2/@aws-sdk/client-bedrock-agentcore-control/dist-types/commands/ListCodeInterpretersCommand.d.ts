...
declare const ListCodeInterpretersCommand_base: {
    new (input: ListCodeInterpretersCommandInput): import("@smithy/core/client").CommandImpl<ListCodeInterpretersCommandInput, ListCodeInterpretersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCodeInterpretersCommandInput]): import("@smithy/core/client").CommandImpl<ListCodeInterpretersCommandInput, ListCodeInterpretersCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
