...
declare const ListAgentRuntimeEndpointsCommand_base: {
    new (input: ListAgentRuntimeEndpointsCommandInput): import("@smithy/core/client").CommandImpl<ListAgentRuntimeEndpointsCommandInput, ListAgentRuntimeEndpointsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAgentRuntimeEndpointsCommandInput): import("@smithy/core/client").CommandImpl<ListAgentRuntimeEndpointsCommandInput, ListAgentRuntimeEndpointsCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
