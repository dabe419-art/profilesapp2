...
declare const ListPolicySummariesCommand_base: {
    new (input: ListPolicySummariesCommandInput): import("@smithy/core/client").CommandImpl<ListPolicySummariesCommandInput, ListPolicySummariesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPolicySummariesCommandInput): import("@smithy/core/client").CommandImpl<ListPolicySummariesCommandInput, ListPolicySummariesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListPolicySummariesCommand extends ListPolicySummariesCommand_base {
