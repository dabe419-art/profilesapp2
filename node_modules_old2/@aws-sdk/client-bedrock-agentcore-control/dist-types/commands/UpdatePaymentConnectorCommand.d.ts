...
declare const UpdatePaymentConnectorCommand_base: {
    new (input: UpdatePaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<UpdatePaymentConnectorCommandInput, UpdatePaymentConnectorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<UpdatePaymentConnectorCommandInput, UpdatePaymentConnectorCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
