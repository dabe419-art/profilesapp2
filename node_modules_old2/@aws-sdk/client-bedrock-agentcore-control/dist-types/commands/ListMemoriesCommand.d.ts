...
declare const ListMemoriesCommand_base: {
    new (input: ListMemoriesCommandInput): import("@smithy/core/client").CommandImpl<ListMemoriesCommandInput, ListMemoriesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMemoriesCommandInput]): import("@smithy/core/client").CommandImpl<ListMemoriesCommandInput, ListMemoriesCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
