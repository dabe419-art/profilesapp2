...
declare const GetBrowserCommand_base: {
    new (input: GetBrowserCommandInput): import("@smithy/core/client").CommandImpl<GetBrowserCommandInput, GetBrowserCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBrowserCommandInput): import("@smithy/core/client").CommandImpl<GetBrowserCommandInput, GetBrowserCommandOutput, import("..").BedrockAgentCoreControlClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
