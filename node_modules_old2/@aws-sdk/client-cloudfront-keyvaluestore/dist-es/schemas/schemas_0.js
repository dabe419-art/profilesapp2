...
export var DeleteKeyRequestListItem$ = [3, n0, _DKRLI,
    0,
    [_K],
    [0], 1
];
...
export var DescribeKeyValueStoreRequest$ = [3, n0, _DKVSR,
    0,
    [_KARN],
    [[0, 1]], 1
];
export var DescribeKeyValueStoreResponse$ = [3, n0, _DKVSRe,
    0,
    [_IC, _TSIB, _KARN, _C, _ET, _LM, _S, _FR],
    [1, 1, 0, 4, [0, { [_hH]: _ET }], 4, 0, 0], 5
];
export var GetKeyRequest$ = [3, n0, _GKR,
    0,
    [_KARN, _K],
    [[0, 1], [0, 1]], 2
];
export var GetKeyResponse$ = [3, n0, _GKRe,
    0,
    [_K, _V, _IC, _TSIB],
    [0, [() => Value, 0], 1, 1], 4
];
...
export var ListKeysResponseListItem$ = [3, n0, _LKRLI,
    0,
    [_K, _V],
    [0, [() => Value, 0]], 2
];
export var PutKeyRequest$ = [3, n0, _PKR,
    0,
    [_K, _V, _KARN, _IM],
    [[0, 1], [() => Value, 0], [0, 1], [0, { [_hH]: _IM_ }]], 4
];
export var PutKeyRequestListItem$ = [3, n0, _PKRLI,
    0,
    [_K, _V],
    [0, [() => Value, 0]], 2
];
export var PutKeyResponse$ = [3, n0, _PKRu,
    0,
    [_IC, _TSIB, _ET],
    [1, 1, [0, { [_hH]: _ET }]], 3
];
...
export var UpdateKeysResponse$ = [3, n0, _UKRp,
    0,
    [_IC, _TSIB, _ET],
    [1, 1, [0, { [_hH]: _ET }]], 3
];
...
export var DescribeKeyValueStore$ = [9, n0, _DKVS,
