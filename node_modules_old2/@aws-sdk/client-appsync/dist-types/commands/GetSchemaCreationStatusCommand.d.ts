...
declare const GetSchemaCreationStatusCommand_base: {
    new (input: GetSchemaCreationStatusCommandInput): import("@smithy/core/client").CommandImpl<GetSchemaCreationStatusCommandInput, GetSchemaCreationStatusCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSchemaCreationStatusCommandInput): import("@smithy/core/client").CommandImpl<GetSchemaCreationStatusCommandInput, GetSchemaCreationStatusCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
