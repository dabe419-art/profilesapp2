...
declare const CreateFunctionCommand_base: {
    new (input: CreateFunctionCommandInput): import("@smithy/core/client").CommandImpl<CreateFunctionCommandInput, CreateFunctionCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateFunctionCommandInput): import("@smithy/core/client").CommandImpl<CreateFunctionCommandInput, CreateFunctionCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
