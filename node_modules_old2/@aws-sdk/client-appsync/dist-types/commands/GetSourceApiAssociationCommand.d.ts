...
declare const GetSourceApiAssociationCommand_base: {
    new (input: GetSourceApiAssociationCommandInput): import("@smithy/core/client").CommandImpl<GetSourceApiAssociationCommandInput, GetSourceApiAssociationCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSourceApiAssociationCommandInput): import("@smithy/core/client").CommandImpl<GetSourceApiAssociationCommandInput, GetSourceApiAssociationCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
