...
declare const ListApiKeysCommand_base: {
    new (input: ListApiKeysCommandInput): import("@smithy/core/client").CommandImpl<ListApiKeysCommandInput, ListApiKeysCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListApiKeysCommandInput): import("@smithy/core/client").CommandImpl<ListApiKeysCommandInput, ListApiKeysCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
