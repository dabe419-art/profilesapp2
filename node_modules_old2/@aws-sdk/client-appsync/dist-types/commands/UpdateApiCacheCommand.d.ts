...
import type { UpdateApiCacheRequest, UpdateApiCacheResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateApiCacheCommand_base: {
    new (input: UpdateApiCacheCommandInput): import("@smithy/core/client").CommandImpl<UpdateApiCacheCommandInput, UpdateApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateApiCacheCommandInput): import("@smithy/core/client").CommandImpl<UpdateApiCacheCommandInput, UpdateApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
