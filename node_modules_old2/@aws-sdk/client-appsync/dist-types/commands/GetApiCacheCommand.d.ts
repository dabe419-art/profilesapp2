...
declare const GetApiCacheCommand_base: {
    new (input: GetApiCacheCommandInput): import("@smithy/core/client").CommandImpl<GetApiCacheCommandInput, GetApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetApiCacheCommandInput): import("@smithy/core/client").CommandImpl<GetApiCacheCommandInput, GetApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
