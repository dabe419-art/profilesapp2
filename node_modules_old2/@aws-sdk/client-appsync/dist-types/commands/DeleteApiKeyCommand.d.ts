...
declare const DeleteApiKeyCommand_base: {
    new (input: DeleteApiKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiKeyCommandInput, DeleteApiKeyCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteApiKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiKeyCommandInput, DeleteApiKeyCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
