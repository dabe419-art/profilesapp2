...
declare const GetIntrospectionSchemaCommand_base: {
    new (input: GetIntrospectionSchemaCommandInput): import("@smithy/core/client").CommandImpl<GetIntrospectionSchemaCommandInput, GetIntrospectionSchemaCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIntrospectionSchemaCommandInput): import("@smithy/core/client").CommandImpl<GetIntrospectionSchemaCommandInput, GetIntrospectionSchemaCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
