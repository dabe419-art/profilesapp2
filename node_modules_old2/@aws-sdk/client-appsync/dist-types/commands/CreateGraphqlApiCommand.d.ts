...
declare const CreateGraphqlApiCommand_base: {
    new (input: CreateGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<CreateGraphqlApiCommandInput, CreateGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<CreateGraphqlApiCommandInput, CreateGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
