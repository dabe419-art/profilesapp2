...
declare const StartDataSourceIntrospectionCommand_base: {
    new (input: StartDataSourceIntrospectionCommandInput): import("@smithy/core/client").CommandImpl<StartDataSourceIntrospectionCommandInput, StartDataSourceIntrospectionCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [StartDataSourceIntrospectionCommandInput]): import("@smithy/core/client").CommandImpl<StartDataSourceIntrospectionCommandInput, StartDataSourceIntrospectionCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
