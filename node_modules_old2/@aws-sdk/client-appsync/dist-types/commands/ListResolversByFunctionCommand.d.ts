...
declare const ListResolversByFunctionCommand_base: {
    new (input: ListResolversByFunctionCommandInput): import("@smithy/core/client").CommandImpl<ListResolversByFunctionCommandInput, ListResolversByFunctionCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListResolversByFunctionCommandInput): import("@smithy/core/client").CommandImpl<ListResolversByFunctionCommandInput, ListResolversByFunctionCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
