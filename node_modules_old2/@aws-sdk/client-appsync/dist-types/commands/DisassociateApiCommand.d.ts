...
import type { DisassociateApiRequest, DisassociateApiResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DisassociateApiCommand_base: {
    new (input: DisassociateApiCommandInput): import("@smithy/core/client").CommandImpl<DisassociateApiCommandInput, DisassociateApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateApiCommandInput): import("@smithy/core/client").CommandImpl<DisassociateApiCommandInput, DisassociateApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
