...
declare const AssociateApiCommand_base: {
    new (input: AssociateApiCommandInput): import("@smithy/core/client").CommandImpl<AssociateApiCommandInput, AssociateApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateApiCommandInput): import("@smithy/core/client").CommandImpl<AssociateApiCommandInput, AssociateApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
