...
declare const GetChannelNamespaceCommand_base: {
    new (input: GetChannelNamespaceCommandInput): import("@smithy/core/client").CommandImpl<GetChannelNamespaceCommandInput, GetChannelNamespaceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetChannelNamespaceCommandInput): import("@smithy/core/client").CommandImpl<GetChannelNamespaceCommandInput, GetChannelNamespaceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
