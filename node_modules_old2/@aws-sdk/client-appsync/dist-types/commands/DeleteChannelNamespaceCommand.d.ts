...
declare const DeleteChannelNamespaceCommand_base: {
    new (input: DeleteChannelNamespaceCommandInput): import("@smithy/core/client").CommandImpl<DeleteChannelNamespaceCommandInput, DeleteChannelNamespaceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteChannelNamespaceCommandInput): import("@smithy/core/client").CommandImpl<DeleteChannelNamespaceCommandInput, DeleteChannelNamespaceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
