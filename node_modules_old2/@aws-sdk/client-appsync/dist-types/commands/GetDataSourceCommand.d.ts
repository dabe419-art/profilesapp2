...
declare const GetDataSourceCommand_base: {
    new (input: GetDataSourceCommandInput): import("@smithy/core/client").CommandImpl<GetDataSourceCommandInput, GetDataSourceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDataSourceCommandInput): import("@smithy/core/client").CommandImpl<GetDataSourceCommandInput, GetDataSourceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
