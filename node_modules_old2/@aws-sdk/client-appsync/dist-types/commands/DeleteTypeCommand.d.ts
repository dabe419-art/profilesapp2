...
declare const DeleteTypeCommand_base: {
    new (input: DeleteTypeCommandInput): import("@smithy/core/client").CommandImpl<DeleteTypeCommandInput, DeleteTypeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTypeCommandInput): import("@smithy/core/client").CommandImpl<DeleteTypeCommandInput, DeleteTypeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
