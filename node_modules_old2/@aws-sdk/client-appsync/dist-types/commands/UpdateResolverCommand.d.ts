...
declare const UpdateResolverCommand_base: {
    new (input: UpdateResolverCommandInput): import("@smithy/core/client").CommandImpl<UpdateResolverCommandInput, UpdateResolverCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateResolverCommandInput): import("@smithy/core/client").CommandImpl<UpdateResolverCommandInput, UpdateResolverCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
