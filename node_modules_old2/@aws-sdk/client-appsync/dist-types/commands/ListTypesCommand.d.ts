...
declare const ListTypesCommand_base: {
    new (input: ListTypesCommandInput): import("@smithy/core/client").CommandImpl<ListTypesCommandInput, ListTypesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTypesCommandInput): import("@smithy/core/client").CommandImpl<ListTypesCommandInput, ListTypesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
