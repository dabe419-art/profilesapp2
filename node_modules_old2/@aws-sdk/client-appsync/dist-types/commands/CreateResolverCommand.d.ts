...
import type { CreateResolverRequest, CreateResolverResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateResolverCommand_base: {
    new (input: CreateResolverCommandInput): import("@smithy/core/client").CommandImpl<CreateResolverCommandInput, CreateResolverCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateResolverCommandInput): import("@smithy/core/client").CommandImpl<CreateResolverCommandInput, CreateResolverCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
