...
declare const DeleteGraphqlApiCommand_base: {
    new (input: DeleteGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<DeleteGraphqlApiCommandInput, DeleteGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<DeleteGraphqlApiCommandInput, DeleteGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
