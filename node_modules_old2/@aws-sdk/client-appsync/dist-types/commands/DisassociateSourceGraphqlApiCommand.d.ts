...
import type { DisassociateSourceGraphqlApiRequest, DisassociateSourceGraphqlApiResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DisassociateSourceGraphqlApiCommand_base: {
    new (input: DisassociateSourceGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSourceGraphqlApiCommandInput, DisassociateSourceGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateSourceGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSourceGraphqlApiCommandInput, DisassociateSourceGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
