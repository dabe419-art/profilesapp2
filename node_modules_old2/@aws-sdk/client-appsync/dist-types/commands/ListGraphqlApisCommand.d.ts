...
declare const ListGraphqlApisCommand_base: {
    new (input: ListGraphqlApisCommandInput): import("@smithy/core/client").CommandImpl<ListGraphqlApisCommandInput, ListGraphqlApisCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListGraphqlApisCommandInput]): import("@smithy/core/client").CommandImpl<ListGraphqlApisCommandInput, ListGraphqlApisCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
