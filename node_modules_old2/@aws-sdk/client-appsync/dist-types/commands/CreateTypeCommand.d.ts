...
declare const CreateTypeCommand_base: {
    new (input: CreateTypeCommandInput): import("@smithy/core/client").CommandImpl<CreateTypeCommandInput, CreateTypeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTypeCommandInput): import("@smithy/core/client").CommandImpl<CreateTypeCommandInput, CreateTypeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
