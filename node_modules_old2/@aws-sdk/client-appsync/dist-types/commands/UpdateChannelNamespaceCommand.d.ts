...
declare const UpdateChannelNamespaceCommand_base: {
    new (input: UpdateChannelNamespaceCommandInput): import("@smithy/core/client").CommandImpl<UpdateChannelNamespaceCommandInput, UpdateChannelNamespaceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateChannelNamespaceCommandInput): import("@smithy/core/client").CommandImpl<UpdateChannelNamespaceCommandInput, UpdateChannelNamespaceCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
