...
declare const GetResolverCommand_base: {
    new (input: GetResolverCommandInput): import("@smithy/core/client").CommandImpl<GetResolverCommandInput, GetResolverCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResolverCommandInput): import("@smithy/core/client").CommandImpl<GetResolverCommandInput, GetResolverCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
