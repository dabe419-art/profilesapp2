...
declare const GetGraphqlApiCommand_base: {
    new (input: GetGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<GetGraphqlApiCommandInput, GetGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<GetGraphqlApiCommandInput, GetGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
