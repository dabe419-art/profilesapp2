...
import type { StartSchemaMergeRequest, StartSchemaMergeResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartSchemaMergeCommand_base: {
    new (input: StartSchemaMergeCommandInput): import("@smithy/core/client").CommandImpl<StartSchemaMergeCommandInput, StartSchemaMergeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartSchemaMergeCommandInput): import("@smithy/core/client").CommandImpl<StartSchemaMergeCommandInput, StartSchemaMergeCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
