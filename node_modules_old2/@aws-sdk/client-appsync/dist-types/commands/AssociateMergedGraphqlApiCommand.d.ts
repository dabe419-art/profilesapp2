...
declare const AssociateMergedGraphqlApiCommand_base: {
    new (input: AssociateMergedGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<AssociateMergedGraphqlApiCommandInput, AssociateMergedGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateMergedGraphqlApiCommandInput): import("@smithy/core/client").CommandImpl<AssociateMergedGraphqlApiCommandInput, AssociateMergedGraphqlApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
