...
declare const StartSchemaCreationCommand_base: {
    new (input: StartSchemaCreationCommandInput): import("@smithy/core/client").CommandImpl<StartSchemaCreationCommandInput, StartSchemaCreationCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartSchemaCreationCommandInput): import("@smithy/core/client").CommandImpl<StartSchemaCreationCommandInput, StartSchemaCreationCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
