...
declare const CreateApiCommand_base: {
    new (input: CreateApiCommandInput): import("@smithy/core/client").CommandImpl<CreateApiCommandInput, CreateApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateApiCommandInput): import("@smithy/core/client").CommandImpl<CreateApiCommandInput, CreateApiCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
