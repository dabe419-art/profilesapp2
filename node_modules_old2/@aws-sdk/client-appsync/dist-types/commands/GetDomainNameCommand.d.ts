...
declare const GetDomainNameCommand_base: {
    new (input: GetDomainNameCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNameCommandInput, GetDomainNameCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDomainNameCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNameCommandInput, GetDomainNameCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
