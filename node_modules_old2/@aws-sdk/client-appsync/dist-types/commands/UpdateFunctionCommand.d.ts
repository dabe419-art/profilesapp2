...
declare const UpdateFunctionCommand_base: {
    new (input: UpdateFunctionCommandInput): import("@smithy/core/client").CommandImpl<UpdateFunctionCommandInput, UpdateFunctionCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFunctionCommandInput): import("@smithy/core/client").CommandImpl<UpdateFunctionCommandInput, UpdateFunctionCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
