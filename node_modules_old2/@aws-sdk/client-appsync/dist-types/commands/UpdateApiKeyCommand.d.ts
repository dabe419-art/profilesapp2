...
declare const UpdateApiKeyCommand_base: {
    new (input: UpdateApiKeyCommandInput): import("@smithy/core/client").CommandImpl<UpdateApiKeyCommandInput, UpdateApiKeyCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateApiKeyCommandInput): import("@smithy/core/client").CommandImpl<UpdateApiKeyCommandInput, UpdateApiKeyCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
