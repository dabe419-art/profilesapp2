...
declare const DeleteApiCacheCommand_base: {
    new (input: DeleteApiCacheCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiCacheCommandInput, DeleteApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteApiCacheCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiCacheCommandInput, DeleteApiCacheCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
