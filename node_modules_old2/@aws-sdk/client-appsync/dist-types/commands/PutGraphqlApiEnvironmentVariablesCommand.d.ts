...
declare const PutGraphqlApiEnvironmentVariablesCommand_base: {
    new (input: PutGraphqlApiEnvironmentVariablesCommandInput): import("@smithy/core/client").CommandImpl<PutGraphqlApiEnvironmentVariablesCommandInput, PutGraphqlApiEnvironmentVariablesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutGraphqlApiEnvironmentVariablesCommandInput): import("@smithy/core/client").CommandImpl<PutGraphqlApiEnvironmentVariablesCommandInput, PutGraphqlApiEnvironmentVariablesCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
