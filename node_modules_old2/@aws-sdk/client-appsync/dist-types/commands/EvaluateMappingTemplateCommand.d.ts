...
declare const EvaluateMappingTemplateCommand_base: {
    new (input: EvaluateMappingTemplateCommandInput): import("@smithy/core/client").CommandImpl<EvaluateMappingTemplateCommandInput, EvaluateMappingTemplateCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EvaluateMappingTemplateCommandInput): import("@smithy/core/client").CommandImpl<EvaluateMappingTemplateCommandInput, EvaluateMappingTemplateCommandOutput, import("..").AppSyncClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
