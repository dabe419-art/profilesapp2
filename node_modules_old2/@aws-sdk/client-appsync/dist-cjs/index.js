...
class AppSyncClient extends Client {
    config;
...
const paginateListApis = createPaginator(AppSyncClient, ListApisCommand, "nextToken", "nextToken", "maxResults");

const paginateListChannelNamespaces = createPaginator(AppSyncClient, ListChannelNamespacesCommand, "nextToken", "nextToken", "maxResults");

const paginateListDataSources = createPaginator(AppSyncClient, ListDataSourcesCommand, "nextToken", "nextToken", "maxResults");

const paginateListDomainNames = createPaginator(AppSyncClient, ListDomainNamesCommand, "nextToken", "nextToken", "maxResults");

const paginateListFunctions = createPaginator(AppSyncClient, ListFunctionsCommand, "nextToken", "nextToken", "maxResults");

const paginateListGraphqlApis = createPaginator(AppSyncClient, ListGraphqlApisCommand, "nextToken", "nextToken", "maxResults");

const paginateListResolversByFunction = createPaginator(AppSyncClient, ListResolversByFunctionCommand, "nextToken", "nextToken", "maxResults");

const paginateListResolvers = createPaginator(AppSyncClient, ListResolversCommand, "nextToken", "nextToken", "maxResults");

const paginateListSourceApiAssociations = createPaginator(AppSyncClient, ListSourceApiAssociationsCommand, "nextToken", "nextToken", "maxResults");

const paginateListTypesByAssociation = createPaginator(AppSyncClient, ListTypesByAssociationCommand, "nextToken", "nextToken", "maxResults");

const paginateListTypes = createPaginator(AppSyncClient, ListTypesCommand, "nextToken", "nextToken", "maxResults");
