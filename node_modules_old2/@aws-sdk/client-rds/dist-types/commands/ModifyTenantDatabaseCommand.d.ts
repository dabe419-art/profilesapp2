...
declare const ModifyTenantDatabaseCommand_base: {
    new (input: ModifyTenantDatabaseCommandInput): import("@smithy/core/client").CommandImpl<ModifyTenantDatabaseCommandInput, ModifyTenantDatabaseCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyTenantDatabaseCommandInput): import("@smithy/core/client").CommandImpl<ModifyTenantDatabaseCommandInput, ModifyTenantDatabaseCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
