...
declare const StartActivityStreamCommand_base: {
    new (input: StartActivityStreamCommandInput): import("@smithy/core/client").CommandImpl<StartActivityStreamCommandInput, StartActivityStreamCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartActivityStreamCommandInput): import("@smithy/core/client").CommandImpl<StartActivityStreamCommandInput, StartActivityStreamCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
