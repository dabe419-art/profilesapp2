...
declare const SwitchoverReadReplicaCommand_base: {
    new (input: SwitchoverReadReplicaCommandInput): import("@smithy/core/client").CommandImpl<SwitchoverReadReplicaCommandInput, SwitchoverReadReplicaCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SwitchoverReadReplicaCommandInput): import("@smithy/core/client").CommandImpl<SwitchoverReadReplicaCommandInput, SwitchoverReadReplicaCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
