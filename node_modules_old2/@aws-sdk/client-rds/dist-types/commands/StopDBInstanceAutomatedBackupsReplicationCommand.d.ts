...
declare const StopDBInstanceAutomatedBackupsReplicationCommand_base: {
    new (input: StopDBInstanceAutomatedBackupsReplicationCommandInput): import("@smithy/core/client").CommandImpl<StopDBInstanceAutomatedBackupsReplicationCommandInput, StopDBInstanceAutomatedBackupsReplicationCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopDBInstanceAutomatedBackupsReplicationCommandInput): import("@smithy/core/client").CommandImpl<StopDBInstanceAutomatedBackupsReplicationCommandInput, StopDBInstanceAutomatedBackupsReplicationCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
