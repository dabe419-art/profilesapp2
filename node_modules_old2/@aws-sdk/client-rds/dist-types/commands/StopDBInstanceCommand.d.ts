...
declare const StopDBInstanceCommand_base: {
    new (input: StopDBInstanceCommandInput): import("@smithy/core/client").CommandImpl<StopDBInstanceCommandInput, StopDBInstanceCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopDBInstanceCommandInput): import("@smithy/core/client").CommandImpl<StopDBInstanceCommandInput, StopDBInstanceCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
