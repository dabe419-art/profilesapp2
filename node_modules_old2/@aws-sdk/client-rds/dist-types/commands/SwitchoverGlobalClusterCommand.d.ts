...
declare const SwitchoverGlobalClusterCommand_base: {
    new (input: SwitchoverGlobalClusterCommandInput): import("@smithy/core/client").CommandImpl<SwitchoverGlobalClusterCommandInput, SwitchoverGlobalClusterCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SwitchoverGlobalClusterCommandInput): import("@smithy/core/client").CommandImpl<SwitchoverGlobalClusterCommandInput, SwitchoverGlobalClusterCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
