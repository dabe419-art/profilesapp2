...
declare const DescribeEngineDefaultClusterParametersCommand_base: {
    new (input: DescribeEngineDefaultClusterParametersCommandInput): import("@smithy/core/client").CommandImpl<DescribeEngineDefaultClusterParametersCommandInput, DescribeEngineDefaultClusterParametersCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeEngineDefaultClusterParametersCommandInput): import("@smithy/core/client").CommandImpl<DescribeEngineDefaultClusterParametersCommandInput, DescribeEngineDefaultClusterParametersCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
