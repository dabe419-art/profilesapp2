...
declare const StartDBClusterCommand_base: {
    new (input: StartDBClusterCommandInput): import("@smithy/core/client").CommandImpl<StartDBClusterCommandInput, StartDBClusterCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDBClusterCommandInput): import("@smithy/core/client").CommandImpl<StartDBClusterCommandInput, StartDBClusterCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
