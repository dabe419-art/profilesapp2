...
declare const CreateGlobalClusterCommand_base: {
    new (input: CreateGlobalClusterCommandInput): import("@smithy/core/client").CommandImpl<CreateGlobalClusterCommandInput, CreateGlobalClusterCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateGlobalClusterCommandInput): import("@smithy/core/client").CommandImpl<CreateGlobalClusterCommandInput, CreateGlobalClusterCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
