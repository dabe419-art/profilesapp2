...
declare const StartDBInstanceCommand_base: {
    new (input: StartDBInstanceCommandInput): import("@smithy/core/client").CommandImpl<StartDBInstanceCommandInput, StartDBInstanceCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDBInstanceCommandInput): import("@smithy/core/client").CommandImpl<StartDBInstanceCommandInput, StartDBInstanceCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
