...
declare const DescribeDBSnapshotTenantDatabasesCommand_base: {
    new (input: DescribeDBSnapshotTenantDatabasesCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBSnapshotTenantDatabasesCommandInput, DescribeDBSnapshotTenantDatabasesCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDBSnapshotTenantDatabasesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDBSnapshotTenantDatabasesCommandInput, DescribeDBSnapshotTenantDatabasesCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
