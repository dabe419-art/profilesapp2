...
declare const DescribeEventCategoriesCommand_base: {
    new (input: DescribeEventCategoriesCommandInput): import("@smithy/core/client").CommandImpl<DescribeEventCategoriesCommandInput, DescribeEventCategoriesCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeEventCategoriesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeEventCategoriesCommandInput, DescribeEventCategoriesCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
