...
declare const RestoreDBInstanceToPointInTimeCommand_base: {
    new (input: RestoreDBInstanceToPointInTimeCommandInput): import("@smithy/core/client").CommandImpl<RestoreDBInstanceToPointInTimeCommandInput, RestoreDBInstanceToPointInTimeCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreDBInstanceToPointInTimeCommandInput): import("@smithy/core/client").CommandImpl<RestoreDBInstanceToPointInTimeCommandInput, RestoreDBInstanceToPointInTimeCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
