...
declare const DescribeDBSnapshotsCommand_base: {
    new (input: DescribeDBSnapshotsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDBSnapshotsCommandInput, DescribeDBSnapshotsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDBSnapshotsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDBSnapshotsCommandInput, DescribeDBSnapshotsCommandOutput, import("..").RDSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
