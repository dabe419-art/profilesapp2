...
declare const DescribeRulesCommand_base: {
    new (input: DescribeRulesCommandInput): import("@smithy/core/client").CommandImpl<DescribeRulesCommandInput, DescribeRulesCommandOutput, import("..").ElasticLoadBalancingV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRulesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRulesCommandInput, DescribeRulesCommandOutput, import("..").ElasticLoadBalancingV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
