...
declare const ModifyRuleCommand_base: {
    new (input: ModifyRuleCommandInput): import("@smithy/core/client").CommandImpl<ModifyRuleCommandInput, ModifyRuleCommandOutput, import("..").ElasticLoadBalancingV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyRuleCommandInput): import("@smithy/core/client").CommandImpl<ModifyRuleCommandInput, ModifyRuleCommandOutput, import("..").ElasticLoadBalancingV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
