...
declare const CreateRuleCommand_base: {
    new (input: CreateRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateRuleCommandInput, CreateRuleCommandOutput, import("..").ElasticLoadBalancingV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateRuleCommandInput, CreateRuleCommandOutput, import("..").ElasticLoadBalancingV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
