...
declare const ListImagesCommand_base: {
    new (input: ListImagesCommandInput): import("@smithy/core/client").CommandImpl<ListImagesCommandInput, ListImagesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListImagesCommandInput): import("@smithy/core/client").CommandImpl<ListImagesCommandInput, ListImagesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
