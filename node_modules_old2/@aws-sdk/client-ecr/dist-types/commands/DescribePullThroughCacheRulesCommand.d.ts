...
declare const DescribePullThroughCacheRulesCommand_base: {
    new (input: DescribePullThroughCacheRulesCommandInput): import("@smithy/core/client").CommandImpl<DescribePullThroughCacheRulesCommandInput, DescribePullThroughCacheRulesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribePullThroughCacheRulesCommandInput]): import("@smithy/core/client").CommandImpl<DescribePullThroughCacheRulesCommandInput, DescribePullThroughCacheRulesCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
