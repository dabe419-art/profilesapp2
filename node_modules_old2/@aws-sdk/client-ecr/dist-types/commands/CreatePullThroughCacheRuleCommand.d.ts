...
declare const CreatePullThroughCacheRuleCommand_base: {
    new (input: CreatePullThroughCacheRuleCommandInput): import("@smithy/core/client").CommandImpl<CreatePullThroughCacheRuleCommandInput, CreatePullThroughCacheRuleCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePullThroughCacheRuleCommandInput): import("@smithy/core/client").CommandImpl<CreatePullThroughCacheRuleCommandInput, CreatePullThroughCacheRuleCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
