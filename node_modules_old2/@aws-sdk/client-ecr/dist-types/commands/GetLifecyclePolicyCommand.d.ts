...
declare const GetLifecyclePolicyCommand_base: {
    new (input: GetLifecyclePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLifecyclePolicyCommandInput, GetLifecyclePolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLifecyclePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLifecyclePolicyCommandInput, GetLifecyclePolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
