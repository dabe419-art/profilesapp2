...
declare const ListImageReferrersCommand_base: {
    new (input: ListImageReferrersCommandInput): import("@smithy/core/client").CommandImpl<ListImageReferrersCommandInput, ListImageReferrersCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListImageReferrersCommandInput): import("@smithy/core/client").CommandImpl<ListImageReferrersCommandInput, ListImageReferrersCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
