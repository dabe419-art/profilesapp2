...
declare const SetRepositoryPolicyCommand_base: {
    new (input: SetRepositoryPolicyCommandInput): import("@smithy/core/client").CommandImpl<SetRepositoryPolicyCommandInput, SetRepositoryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetRepositoryPolicyCommandInput): import("@smithy/core/client").CommandImpl<SetRepositoryPolicyCommandInput, SetRepositoryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
