...
declare const DeleteRegistryPolicyCommand_base: {
    new (input: DeleteRegistryPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteRegistryPolicyCommandInput, DeleteRegistryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteRegistryPolicyCommandInput]): import("@smithy/core/client").CommandImpl<DeleteRegistryPolicyCommandInput, DeleteRegistryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
