...
declare const GetSigningConfigurationCommand_base: {
    new (input: GetSigningConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetSigningConfigurationCommandInput, GetSigningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetSigningConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<GetSigningConfigurationCommandInput, GetSigningConfigurationCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
