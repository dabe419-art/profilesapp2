...
declare const StartImageScanCommand_base: {
    new (input: StartImageScanCommandInput): import("@smithy/core/client").CommandImpl<StartImageScanCommandInput, StartImageScanCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartImageScanCommandInput): import("@smithy/core/client").CommandImpl<StartImageScanCommandInput, StartImageScanCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
