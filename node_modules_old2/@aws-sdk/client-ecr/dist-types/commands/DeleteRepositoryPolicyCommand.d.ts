...
declare const DeleteRepositoryPolicyCommand_base: {
    new (input: DeleteRepositoryPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteRepositoryPolicyCommandInput, DeleteRepositoryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRepositoryPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteRepositoryPolicyCommandInput, DeleteRepositoryPolicyCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
