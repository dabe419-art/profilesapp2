...
declare const UploadLayerPartCommand_base: {
    new (input: UploadLayerPartCommandInput): import("@smithy/core/client").CommandImpl<UploadLayerPartCommandInput, UploadLayerPartCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UploadLayerPartCommandInput): import("@smithy/core/client").CommandImpl<UploadLayerPartCommandInput, UploadLayerPartCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
