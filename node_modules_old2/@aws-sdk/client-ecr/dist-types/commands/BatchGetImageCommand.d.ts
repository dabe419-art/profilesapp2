...
declare const BatchGetImageCommand_base: {
    new (input: BatchGetImageCommandInput): import("@smithy/core/client").CommandImpl<BatchGetImageCommandInput, BatchGetImageCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetImageCommandInput): import("@smithy/core/client").CommandImpl<BatchGetImageCommandInput, BatchGetImageCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
