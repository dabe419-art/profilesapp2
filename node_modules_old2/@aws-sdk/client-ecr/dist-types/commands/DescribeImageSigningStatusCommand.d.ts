...
declare const DescribeImageSigningStatusCommand_base: {
    new (input: DescribeImageSigningStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageSigningStatusCommandInput, DescribeImageSigningStatusCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImageSigningStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageSigningStatusCommandInput, DescribeImageSigningStatusCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
