...
declare const CreateRepositoryCreationTemplateCommand_base: {
    new (input: CreateRepositoryCreationTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateRepositoryCreationTemplateCommandInput, CreateRepositoryCreationTemplateCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRepositoryCreationTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateRepositoryCreationTemplateCommandInput, CreateRepositoryCreationTemplateCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
