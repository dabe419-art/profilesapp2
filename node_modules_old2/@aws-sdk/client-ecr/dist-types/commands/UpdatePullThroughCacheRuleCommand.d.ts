...
declare const UpdatePullThroughCacheRuleCommand_base: {
    new (input: UpdatePullThroughCacheRuleCommandInput): import("@smithy/core/client").CommandImpl<UpdatePullThroughCacheRuleCommandInput, UpdatePullThroughCacheRuleCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePullThroughCacheRuleCommandInput): import("@smithy/core/client").CommandImpl<UpdatePullThroughCacheRuleCommandInput, UpdatePullThroughCacheRuleCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
