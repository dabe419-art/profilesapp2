...
declare const GetAccountSettingCommand_base: {
    new (input: GetAccountSettingCommandInput): import("@smithy/core/client").CommandImpl<GetAccountSettingCommandInput, GetAccountSettingCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAccountSettingCommandInput): import("@smithy/core/client").CommandImpl<GetAccountSettingCommandInput, GetAccountSettingCommandOutput, import("..").ECRClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
