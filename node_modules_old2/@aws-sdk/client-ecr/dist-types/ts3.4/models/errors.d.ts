...
export declare class PullThroughCacheRuleAlreadyExistsException extends __BaseException {
  ...
  readonly $fault: "client";
  constructor(
    opts: __ExceptionOptionType<PullThroughCacheRuleAlreadyExistsException, __BaseException>,
  );
}
...
export declare class LifecyclePolicyPreviewNotFoundException extends __BaseException {
  ...
  readonly $fault: "client";
  constructor(
    opts: __ExceptionOptionType<LifecyclePolicyPreviewNotFoundException, __BaseException>,
  );
}
export declare class UnableToListUpstreamImageReferrersException extends __BaseException {
  ...
  readonly $fault: "client";
  constructor(
    opts: __ExceptionOptionType<UnableToListUpstreamImageReferrersException, __BaseException>,
  );
}
...
export declare class LifecyclePolicyPreviewInProgressException extends __BaseException {
  ...
  readonly $fault: "client";
  constructor(
    opts: __ExceptionOptionType<LifecyclePolicyPreviewInProgressException, __BaseException>,
  );
}
export declare class ImageStorageClassUpdateNotSupportedException extends __BaseException {
  ...
  readonly $fault: "client";
  constructor(
    opts: __ExceptionOptionType<ImageStorageClassUpdateNotSupportedException, __BaseException>,
  );
}
