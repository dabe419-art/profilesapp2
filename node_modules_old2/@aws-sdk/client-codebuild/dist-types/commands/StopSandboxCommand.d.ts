...
declare const StopSandboxCommand_base: {
    new (input: StopSandboxCommandInput): import("@smithy/core/client").CommandImpl<StopSandboxCommandInput, StopSandboxCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopSandboxCommandInput): import("@smithy/core/client").CommandImpl<StopSandboxCommandInput, StopSandboxCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
