...
declare const ListBuildsForProjectCommand_base: {
    new (input: ListBuildsForProjectCommandInput): import("@smithy/core/client").CommandImpl<ListBuildsForProjectCommandInput, ListBuildsForProjectCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListBuildsForProjectCommandInput): import("@smithy/core/client").CommandImpl<ListBuildsForProjectCommandInput, ListBuildsForProjectCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
