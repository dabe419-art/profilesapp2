...
declare const ListSharedReportGroupsCommand_base: {
    new (input: ListSharedReportGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListSharedReportGroupsCommandInput, ListSharedReportGroupsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSharedReportGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListSharedReportGroupsCommandInput, ListSharedReportGroupsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
