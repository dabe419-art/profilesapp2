...
declare const StartSandboxConnectionCommand_base: {
    new (input: StartSandboxConnectionCommandInput): import("@smithy/core/client").CommandImpl<StartSandboxConnectionCommandInput, StartSandboxConnectionCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartSandboxConnectionCommandInput): import("@smithy/core/client").CommandImpl<StartSandboxConnectionCommandInput, StartSandboxConnectionCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
