...
declare const GetReportGroupTrendCommand_base: {
    new (input: GetReportGroupTrendCommandInput): import("@smithy/core/client").CommandImpl<GetReportGroupTrendCommandInput, GetReportGroupTrendCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetReportGroupTrendCommandInput): import("@smithy/core/client").CommandImpl<GetReportGroupTrendCommandInput, GetReportGroupTrendCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
