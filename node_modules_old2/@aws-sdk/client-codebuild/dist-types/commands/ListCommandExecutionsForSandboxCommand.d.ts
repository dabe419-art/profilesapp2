...
declare const ListCommandExecutionsForSandboxCommand_base: {
    new (input: ListCommandExecutionsForSandboxCommandInput): import("@smithy/core/client").CommandImpl<ListCommandExecutionsForSandboxCommandInput, ListCommandExecutionsForSandboxCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListCommandExecutionsForSandboxCommandInput): import("@smithy/core/client").CommandImpl<ListCommandExecutionsForSandboxCommandInput, ListCommandExecutionsForSandboxCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
