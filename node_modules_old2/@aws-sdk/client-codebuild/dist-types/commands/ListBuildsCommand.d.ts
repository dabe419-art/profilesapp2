...
declare const ListBuildsCommand_base: {
    new (input: ListBuildsCommandInput): import("@smithy/core/client").CommandImpl<ListBuildsCommandInput, ListBuildsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListBuildsCommandInput]): import("@smithy/core/client").CommandImpl<ListBuildsCommandInput, ListBuildsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
