...
declare const StartBuildCommand_base: {
    new (input: StartBuildCommandInput): import("@smithy/core/client").CommandImpl<StartBuildCommandInput, StartBuildCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartBuildCommandInput): import("@smithy/core/client").CommandImpl<StartBuildCommandInput, StartBuildCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
