...
declare const ListFleetsCommand_base: {
    new (input: ListFleetsCommandInput): import("@smithy/core/client").CommandImpl<ListFleetsCommandInput, ListFleetsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFleetsCommandInput]): import("@smithy/core/client").CommandImpl<ListFleetsCommandInput, ListFleetsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
