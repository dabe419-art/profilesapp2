...
declare const UpdateFleetCommand_base: {
    new (input: UpdateFleetCommandInput): import("@smithy/core/client").CommandImpl<UpdateFleetCommandInput, UpdateFleetCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFleetCommandInput): import("@smithy/core/client").CommandImpl<UpdateFleetCommandInput, UpdateFleetCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
