...
declare const StartSandboxCommand_base: {
    new (input: StartSandboxCommandInput): import("@smithy/core/client").CommandImpl<StartSandboxCommandInput, StartSandboxCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [StartSandboxCommandInput]): import("@smithy/core/client").CommandImpl<StartSandboxCommandInput, StartSandboxCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
