...
declare const RetryBuildCommand_base: {
    new (input: RetryBuildCommandInput): import("@smithy/core/client").CommandImpl<RetryBuildCommandInput, RetryBuildCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [RetryBuildCommandInput]): import("@smithy/core/client").CommandImpl<RetryBuildCommandInput, RetryBuildCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
