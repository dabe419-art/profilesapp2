...
declare const StopBuildCommand_base: {
    new (input: StopBuildCommandInput): import("@smithy/core/client").CommandImpl<StopBuildCommandInput, StopBuildCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopBuildCommandInput): import("@smithy/core/client").CommandImpl<StopBuildCommandInput, StopBuildCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
