...
declare const RetryBuildBatchCommand_base: {
    new (input: RetryBuildBatchCommandInput): import("@smithy/core/client").CommandImpl<RetryBuildBatchCommandInput, RetryBuildBatchCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [RetryBuildBatchCommandInput]): import("@smithy/core/client").CommandImpl<RetryBuildBatchCommandInput, RetryBuildBatchCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
