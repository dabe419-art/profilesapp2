...
declare const StartCommandExecutionCommand_base: {
    new (input: StartCommandExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartCommandExecutionCommandInput, StartCommandExecutionCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartCommandExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartCommandExecutionCommandInput, StartCommandExecutionCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
