...
declare const ListCuratedEnvironmentImagesCommand_base: {
    new (input: ListCuratedEnvironmentImagesCommandInput): import("@smithy/core/client").CommandImpl<ListCuratedEnvironmentImagesCommandInput, ListCuratedEnvironmentImagesCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCuratedEnvironmentImagesCommandInput]): import("@smithy/core/client").CommandImpl<ListCuratedEnvironmentImagesCommandInput, ListCuratedEnvironmentImagesCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
