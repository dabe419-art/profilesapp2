...
declare const ListReportGroupsCommand_base: {
    new (input: ListReportGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListReportGroupsCommandInput, ListReportGroupsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListReportGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListReportGroupsCommandInput, ListReportGroupsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
