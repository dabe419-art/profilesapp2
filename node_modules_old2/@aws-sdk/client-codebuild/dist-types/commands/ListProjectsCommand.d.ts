...
declare const ListProjectsCommand_base: {
    new (input: ListProjectsCommandInput): import("@smithy/core/client").CommandImpl<ListProjectsCommandInput, ListProjectsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListProjectsCommandInput]): import("@smithy/core/client").CommandImpl<ListProjectsCommandInput, ListProjectsCommandOutput, import("..").CodeBuildClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
