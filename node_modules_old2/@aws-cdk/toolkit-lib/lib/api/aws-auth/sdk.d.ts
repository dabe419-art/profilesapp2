...
import type { DescribeServicesCommandInput, DescribeServicesCommandOutput, DescribeTaskDefinitionCommandInput, DescribeTaskDefinitionCommandOutput, DescribeTasksCommandInput, DescribeTasksCommandOutput, ListTasksCommandInput, ListTasksCommandOutput, RegisterTaskDefinitionCommandInput, ListClustersCommandInput, ListClustersCommandOutput, RegisterTaskDefinitionCommandOutput, UpdateServiceCommandInput, UpdateServiceCommandOutput } from '@aws-sdk/client-ecs';
...
export declare class SDK {
    ...
    bedrockAgentCoreControl(): IBedrockAgentCoreControlClient;
 ...
 */
export declare function cappedExponentialBackoff(baseMs: number, capMs: number): (attempt: number) => number;
