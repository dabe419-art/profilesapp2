...
import { parse as parse5 } from "graphql";

// ../../node_modules/@graphql-codegen/core/esm/codegen.js
import { Kind as Kind31, print as print5, specifiedRules as specifiedRules2, visit as visit4 } from "graphql";

// ../../node_modules/@graphql-codegen/plugin-helpers/esm/federation.js
import { GraphQLInterfaceType, GraphQLObjectType, isObjectType as isObjectType2, parse as parse2 } from "graphql";

// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/helpers.js
import { parse } from "graphql";
function isSome(input) {
  return input != null;
}

// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/getDirectiveExtensions.js
import { valueFromAST as valueFromAST2, valueFromASTUntyped as valueFromASTUntyped2 } from "graphql";
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/getArgumentValues.js
import { isNonNullType, Kind, print, valueFromAST, valueFromASTUntyped } from "graphql";

// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/errors.js
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/jsutils.js
...
function getArgumentValues(def, node, variableValues = {}) {
  ...
  for (const arg of def.args) {
    ...
    if (!argumentNode) {
      ...
      } else if (arg.defaultValue !== void 0) {
    ...
    if (valueNode.kind === Kind.VARIABLE) {
      ...
      if (variableValues == null || !hasOwnProperty(variableValues, variableName)) {
        if (arg.defaultValue !== void 0) {
          ...
          throw createGraphQLError(`Argument "${arg.name}" of required type "${inspect(arg.type)}" was provided the variable "$${variableName}" which was not provided a runtime value.`, {
            nodes: [valueNode]
          });
        }
        continue;
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/memoize.js
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/get-directives.js
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/print-schema-with-directives.js
import { GraphQLDeprecatedDirective, isEnumType as isEnumType2, isInputObjectType as isInputObjectType2, isInterfaceType, isIntrospectionType, isObjectType, isScalarType, isSpecifiedDirective, isSpecifiedScalarType, isUnionType, Kind as Kind6, print as print2, specifiedDirectives } from "graphql";

// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/astFromType.js
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/astFromValue.js
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/astFromValueUntyped.js
...
function astFromValue(value, type) {
  ...
  if (isLeafType(type)) {
    ...
    if (type.name === "ID" && typeof value === "string" && integerStringRegExp2.test(value)) {
      return { kind: Kind4.INT, value };
    }
  }
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/defaultValueAstFromType.js
import { valueFromASTUntyped as valueFromASTUntyped3 } from "graphql";
var defaultValueAstFromType = (arg) => {
  if ("default" in arg) {
    ...
    if ("value" in arg.default) {
      return astFromValueUntyped(arg.default.value) ?? void 0;
    }
    const value = valueFromASTUntyped3(arg.default.literal);
    return astFromValue(value, arg.type) ?? void 0;
  }
  return arg.defaultValue !== void 0 ? astFromValue(arg.defaultValue, arg.type) ?? void 0 : void 0;
};

// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/descriptionFromObject.js
...
// ../../node_modules/@graphql-codegen/plugin-helpers/node_modules/@graphql-tools/utils/esm/rootTypes.js
...
function astFromSchema(schema, pathToDirectivesInExtensions) {
  ...
  const schemaNode = {
    kind: operationTypes.length ? Kind6.SCHEMA_DEFINITION : Kind6.SCHEMA_EXTENSION,
    operationTypes,
...
// ../../node_modules/@graphql-codegen/plugin-helpers/esm/utils.js
...
// ../../node_modules/@graphql-codegen/plugin-helpers/esm/helpers.js
import { isListType as isListType4, isNonNullType as isNonNullType5, isObjectType as isObjectType3, Kind as Kind7, visit } from "graphql";
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/schema/esm/assertResolversPresent.js
...
import { valueFromAST as valueFromAST4, valueFromASTUntyped as valueFromASTUntyped4 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/getArgumentValues.js
import { isNonNullType as isNonNullType6, Kind as Kind8, print as print3, valueFromAST as valueFromAST3 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/errors.js
import { locatedError as _locatedError2, GraphQLError as GraphQLError2, versionInfo as versionInfo2 } from "graphql";
...
function createGraphQLError2(message, options) {
  ...
  const Constructor = GraphQLError2;
  const error = versionInfo2.major >= 16 ? new Constructor(message, options) : new Constructor(message, options?.nodes, options?.source, options?.positions, options?.path, options?.originalError, options?.extensions);
  if (options?.coordinate && error.coordinate == null) {
    Object.defineProperties(error, {
      coordinate: { value: options.coordinate, enumerable: true, configurable: true }
    });
...
function getArgumentValues2(def, node, variableValues = {}) {
  ...
  for (const { name, type: argType, defaultValue } of def.args) {
    ...
    const valueNode = argumentNode.value;
    let isNull = valueNode.kind === Kind8.NULL;
    if (valueNode.kind === Kind8.VARIABLE) {
      const variableName = valueNode.name.value;
      ...
      for (const directive of astNode.directives) {
        ...
        if (directive.arguments) {
          for (const argNode of directive.arguments) {
            ...
            if (value[argName] == null) {
              value[argName] = valueFromASTUntyped4(argNode.value);
            }
          }
        }
        if (astNodes.length > 0 && existingDirectiveExtensions.length > 0) {
...
import { isEnumType as isEnumType3, isInputObjectType as isInputObjectType3, isLeafType as isLeafType2, isListType as isListType6, isNonNullType as isNonNullType8, Kind as Kind11 } from "graphql";
...
function astFromValueUntyped2(value) {
  ...
  if (Array.isArray(value)) {
    ...
    return { kind: Kind10.LIST, values: valuesNodes };
  }
  if (typeof value === "object") {
    if (value?.toJSON) {
    ...
    for (const fieldName in value) {
      ...
      if (ast) {
        fieldNodes.push({
          kind: Kind10.OBJECT_FIELD,
          name: { kind: Kind10.NAME, value: fieldName },
          value: ast
        });
      }
    }
    return { kind: Kind10.OBJECT, fields: fieldNodes };
  }
  if (typeof value === "boolean") {
    return { kind: Kind10.BOOLEAN, value };
  }
  if (typeof value === "bigint") {
    return { kind: Kind10.INT, value: String(value) };
  }
  if (typeof value === "number" && isFinite(value)) {
    const stringNum = String(value);
    return integerStringRegExp3.test(stringNum) ? { kind: Kind10.INT, value: stringNum } : { kind: Kind10.FLOAT, value: stringNum };
  }
  if (typeof value === "string") {
    return { kind: Kind10.STRING, value };
  }
  throw new TypeError(`Cannot convert value to AST: ${value}.`);
}
...
function astFromValue2(value, type) {
  if (isNonNullType8(type)) {
    ...
    if (astValue?.kind === Kind11.NULL) {
      return null;
    }
    return astValue;
  }
  if (value === null) {
    return { kind: Kind11.NULL };
  }
  if (value === void 0) {
    return null;
  }
  if (isListType6(type)) {
    ...
    if (isIterableObject2(value)) {
      ...
      return { kind: Kind11.LIST, values: valuesNodes };
    }
  ...
  if (isInputObjectType3(type)) {
    ...
    for (const field of Object.values(type.getFields())) {
      ...
      if (fieldValue) {
        fieldNodes.push({
          kind: Kind11.OBJECT_FIELD,
          name: { kind: Kind11.NAME, value: field.name },
          value: fieldValue
        });
      }
    }
    return { kind: Kind11.OBJECT, fields: fieldNodes };
  }
  if (isLeafType2(type)) {
    if (isEnumType3(type)) {
      const values = type.getValues();
    ...
    if (type.name === "ID" && typeof value === "string" && integerStringRegExp4.test(value)) {
      return { kind: Kind11.INT, value };
    }
  }
  return astFromValueUntyped2(value);
}
...
function astFromSchema2(schema, pathToDirectivesInExtensions) {
  ...
  for (const [operationTypeNode, operationTypeDefinitionNode] of operationTypeMap) {
    ...
    if (rootType != null) {
      ...
      if (operationTypeDefinitionNode != null) {
        ...
        operationTypeMap.set(operationTypeNode, {
          kind: Kind13.OPERATION_TYPE_DEFINITION,
          operation: operationTypeNode,
          type: rootTypeAST
        });
      }
  ...
  const schemaNode = {
    kind: operationTypes.length ? Kind13.SCHEMA_DEFINITION : Kind13.SCHEMA_EXTENSION,
    operationTypes,
    // ConstXNode has been introduced in v16 but it is not compatible with XNode so we do `as any` for backwards compatibility
    directives
  };
...
function astFromDirective2(directive, schema, pathToDirectivesInExtensions) {
  return {
    kind: Kind13.DIRECTIVE_DEFINITION,
...
function getDirectiveNodes2(entity, schema, pathToDirectivesInExtensions) {
  ...
  let oneOfDirectiveNode = null;
  if (directives != null) {
    directiveNodesBesidesNativeDirectives = directives.filter((directive) => specifiedDirectives2.every((specifiedDirective) => specifiedDirective.name !== directive.name.value));
    deprecatedDirectiveNode = directives.find((directive) => directive.name.value === "deprecated");
    specifiedByDirectiveNode = directives.find((directive) => directive.name.value === "specifiedBy");
    oneOfDirectiveNode = directives.find((directive) => directive.name.value === "oneOf");
  }
  ...
  if (entity.isOneOf && oneOfDirectiveNode == null) {
    oneOfDirectiveNode = makeDirectiveNode2("oneOf");
  }
  if (deprecatedDirectiveNode != null) {
    directiveNodesBesidesNativeDirectives.push(deprecatedDirectiveNode);
  }
...
function astFromArg2(arg, schema, pathToDirectivesInExtensions) {
  return {
    kind: Kind13.INPUT_VALUE_DEFINITION,
...
function astFromObjectType2(type, schema, pathToDirectivesInExtensions) {
  return {
    kind: Kind13.OBJECT_TYPE_DEFINITION,
...
function astFromInterfaceType2(type, schema, pathToDirectivesInExtensions) {
  const node = {
    kind: Kind13.INTERFACE_TYPE_DEFINITION,
    description: getDescriptionNode2(type),
    name: {
      kind: Kind13.NAME,
      value: type.name
...
function astFromInputObjectType2(type, schema, pathToDirectivesInExtensions) {
  return {
    kind: Kind13.INPUT_OBJECT_TYPE_DEFINITION,
    description: getDescriptionNode2(type),
    name: {
      kind: Kind13.NAME,
      value: type.name
...
function astFromEnumType2(type, schema, pathToDirectivesInExtensions) {
  return {
    kind: Kind13.ENUM_TYPE_DEFINITION,
    description: getDescriptionNode2(type),
    name: {
      kind: Kind13.NAME,
      value: type.name
...
function astFromScalarType2(type, schema, pathToDirectivesInExtensions) {
  ...
  return {
    kind: Kind13.SCALAR_TYPE_DEFINITION,
    description: getDescriptionNode2(type),
    name: {
      kind: Kind13.NAME,
      value: type.name
...
function astFromEnumValue2(value, schema, pathToDirectivesInExtensions) {
  return {
    kind: Kind13.ENUM_VALUE_DEFINITION,
...
import { Kind as Kind14, specifiedRules, validate, versionInfo as versionInfo3 } from "graphql";
function validateGraphQlDocuments(schema, documents, rules = createDefaultRules()) {
  ...
  for (const document of documents) {
    for (const docDefinition of document.definitions) {
      if (docDefinition.kind === Kind14.FRAGMENT_DEFINITION) {
...
function createDefaultRules() {
  ...
  if (versionInfo3.major < 15) {
    ignored = ignored.map((rule) => rule.replace(/Rule$/, ""));
  }
  return specifiedRules.filter((f) => !ignored.includes(f.name));
}

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/comments.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/Interfaces.js
var MapperKind;
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/mapSchema.js
import { GraphQLEnumType as GraphQLEnumType2, GraphQLInputObjectType as GraphQLInputObjectType3, GraphQLInterfaceType as GraphQLInterfaceType4, GraphQLList as GraphQLList3, GraphQLNonNull as GraphQLNonNull3, GraphQLObjectType as GraphQLObjectType4, GraphQLSchema, isEnumType as isEnumType6, isInputObjectType as isInputObjectType7, isInterfaceType as isInterfaceType4, isLeafType as isLeafType4, isListType as isListType9, isNamedType as isNamedType2, isNonNullType as isNonNullType10, isObjectType as isObjectType7, isScalarType as isScalarType4, isUnionType as isUnionType4, Kind as Kind16 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/getObjectTypeFromTypeMap.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/rewire.js
import { GraphQLDirective, GraphQLEnumType, GraphQLInputObjectType as GraphQLInputObjectType2, GraphQLInterfaceType as GraphQLInterfaceType3, GraphQLList as GraphQLList2, GraphQLNonNull as GraphQLNonNull2, GraphQLObjectType as GraphQLObjectType3, GraphQLScalarType, GraphQLUnionType, isEnumType as isEnumType5, isInputObjectType as isInputObjectType5, isInterfaceType as isInterfaceType3, isListType as isListType7, isNamedType, isNonNullType as isNonNullType9, isObjectType as isObjectType6, isScalarType as isScalarType3, isSpecifiedDirective as isSpecifiedDirective3, isSpecifiedScalarType as isSpecifiedScalarType3, isUnionType as isUnionType3 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/stub.js
import { GraphQLBoolean, GraphQLFloat, GraphQLID, GraphQLInputObjectType, GraphQLInt, GraphQLInterfaceType as GraphQLInterfaceType2, GraphQLList, GraphQLNonNull, GraphQLObjectType as GraphQLObjectType2, GraphQLString, Kind as Kind15 } from "graphql";
...
function rewireTypes(originalTypeMap, directives) {
  ...
  function rewireNamedType(type) {
    if (isObjectType6(type)) {
      ...
      return new GraphQLInterfaceType3(newConfig);
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/transformInputValue.js
  ...
  for (const typeName in originalTypeMap) {
    if (!typeName.startsWith("__")) {
      ...
      if (isObjectType7(originalType)) {
        ...
        newTypeMap[typeName] = correctASTNodes(new GraphQLInterfaceType4({
          ...config,
          fields: newFieldConfigMap
        }));
      } else {
  ...
  for (const typeName in originalTypeMap) {
    if (!typeName.startsWith("__")) {
      ...
      if (isObjectType7(originalType)) {
        ...
        newTypeMap[typeName] = new GraphQLInterfaceType4({
          ...config,
          fields: newFieldConfigMap
        });
      } else {
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/heal.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/getResolversFromSchema.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/forEachField.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/forEachDefaultValue.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/mergeDeep.js
...
function isDocumentNode(object) {
  return object && typeof object === "object" && "kind" in object && object.kind === Kind17.DOCUMENT;
}

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/utils/esm/extractExtensionsFromSchema.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/schema/esm/addResolversToSchema.js
import { GraphQLEnumType as GraphQLEnumType3, GraphQLInterfaceType as GraphQLInterfaceType5, GraphQLObjectType as GraphQLObjectType5, GraphQLScalarType as GraphQLScalarType3, GraphQLUnionType as GraphQLUnionType2, isEnumType as isEnumType8, isInterfaceType as isInterfaceType7, isObjectType as isObjectType12, isScalarType as isScalarType7, isSpecifiedScalarType as isSpecifiedScalarType5, isUnionType as isUnionType7 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/schema/esm/checkForResolveTypeResolver.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/schema/esm/extendResolversFromInterfaces.js
  ...
  schema = mapSchema(schema, {
    ...
    [MapperKind.INTERFACE_TYPE]: (type) => {
      ...
      if (resolverValue != null) {
        ...
        return new GraphQLInterfaceType5(config);
      }
    },
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/schema/esm/makeExecutableSchema.js
import { buildASTSchema, buildSchema, isSchema as isSchema2 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/merge-resolvers.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/arguments.js
function mergeArguments(args1, args2, config) {
  const result = deduplicateArguments([...args2, ...args1].filter(isSome2), config);
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/directives.js
...
var getLinkDirectiveURL = (directive) => {
  const stringValue = isLinkDirective(directive) ? directive.arguments?.find((arg) => arg.name.value === "url")?.value : void 0;
  return stringValue?.kind === "StringValue" ? stringValue.value : void 0;
};
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/enum-values.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/enum.js
...
function mergeEnum(e1, e2, config, directives) {
  ...
  return config?.convertExtensions ? {
    ...e1,
    kind: Kind19.ENUM_TYPE_DEFINITION
  } : e1;
}

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/utils.js
import { Kind as Kind20, Source } from "graphql";
...
function extractType(type) {
  ...
  while (visitedType.kind === Kind20.LIST_TYPE || visitedType.kind === "NonNullType") {
    visitedType = visitedType.type;
  }
  return visitedType;
}
function isWrappingTypeNode(type) {
  return type.kind !== Kind20.NAMED_TYPE;
}
function isListTypeNode(type) {
  return type.kind === Kind20.LIST_TYPE;
}
function isNonNullTypeNode(type) {
  return type.kind === Kind20.NON_NULL_TYPE;
}
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/fields.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/input-type.js
...
function mergeInputType(node, existingNode, config, directives) {
  ...
  return config?.convertExtensions ? {
    ...node,
    kind: Kind21.INPUT_OBJECT_TYPE_DEFINITION
  } : node;
}

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/interface.js
import { Kind as Kind22 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/merge-named-type-array.js
...
function mergeInterface(node, existingNode, config, directives) {
  ...
  return config?.convertExtensions ? {
    ...node,
    kind: Kind22.INTERFACE_TYPE_DEFINITION
  } : node;
}

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/merge-nodes.js
import { Kind as Kind27 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/scalar.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/schema-def.js
...
function mergeSchemaDefs(node, existingNode, config, directives) {
  if (existingNode) {
    return {
      kind: node.kind === Kind24.SCHEMA_DEFINITION || existingNode.kind === Kind24.SCHEMA_DEFINITION ? Kind24.SCHEMA_DEFINITION : Kind24.SCHEMA_EXTENSION,
      description: node["description"] || existingNode["description"],
      directives: mergeDirectives(node.directives, existingNode.directives, config, directives),
  ...
  return config?.convertExtensions ? {
    ...node,
    kind: Kind24.SCHEMA_DEFINITION
  } : node;
}

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/type.js
...
function mergeType(node, existingNode, config, directives) {
  ...
  return config?.convertExtensions ? {
    ...node,
    kind: Kind25.OBJECT_TYPE_DEFINITION
  } : node;
}

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/union.js
...
function mergeUnion(first, second, config, directives) {
  if (second) {
    return {
      ...
      kind: config?.convertExtensions || first.kind === "UnionTypeDefinition" || second.kind === "UnionTypeDefinition" ? Kind26.UNION_TYPE_DEFINITION : Kind26.UNION_TYPE_EXTENSION,
      loc: first.loc,
  ...
  return config?.convertExtensions ? {
    ...first,
    kind: Kind26.UNION_TYPE_DEFINITION
  } : first;
}
...
function mergeGraphQLNodes(nodes, config, directives = {}) {
  ...
  for (const nodeDefinition of nodes) {
    ...
    } else if (nodeDefinition.kind === Kind27.SCHEMA_DEFINITION || nodeDefinition.kind === Kind27.SCHEMA_EXTENSION) {
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/typedefs-mergers/merge-typedefs.js
import { isDefinitionNode, isSchema, Kind as Kind29, parse as parse4 } from "graphql";

// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/links.js
...
function extractLinks(typeDefs) {
  ...
  for (const definition of typeDefs.definitions) {
    if (definition.kind === Kind28.SCHEMA_EXTENSION || definition.kind === Kind28.SCHEMA_DEFINITION) {
...
function linkFromArgs(args) {
  ...
  for (const arg of args) {
    switch (arg.name.value) {
      case "url": {
        if (arg.value.kind === Kind28.STRING) {
...
function linkFromCoreArgs(args) {
  const feature = args.find(({ name, value }) => name.value === "feature" && value.kind === Kind28.STRING);
  if (feature) {
...
function parseImportNode(node) {
  if (node.kind === Kind28.LIST) {
    const imports = node.values.map((v) => {
      let namedImport;
      if (v.kind === Kind28.STRING) {
        namedImport = { name: v.value };
      } else if (v.kind === Kind28.OBJECT) {
        let name = "";
        let as;
        for (const f of v.fields) {
          if (f.name.value === "name") {
            if (f.value.kind === Kind28.STRING) {
              name = f.value.value;
            }
...
function visitTypeSources(typeSource, options, allDirectives = [], allNodes = [], visitedTypeSources = /* @__PURE__ */ new Set(), repeatableLinkImports = /* @__PURE__ */ new Set()) {
  ...
  if (typeSource && !visitedTypeSources.has(typeSource)) {
    ...
    if (typeof typeSource === "function") {
      ...
      if (typeSource.kind === Kind29.DIRECTIVE_DEFINITION) {
    ...
    for (const opTypeDefNodeType in DEFAULT_OPERATION_TYPE_NAME_MAP) {
      ...
      if (!opTypeDefNode) {
        ...
        if (existingPossibleRootType != null && existingPossibleRootType.name != null) {
          operationTypes.push({
            kind: Kind29.OPERATION_TYPE_DEFINITION,
            type: {
              kind: Kind29.NAMED_TYPE,
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/merge/esm/extensions.js
...
// ../../node_modules/@graphql-codegen/core/node_modules/@graphql-tools/schema/esm/merge-schemas.js
...
import { isSchema as isSchema3, Kind as Kind30 } from "graphql";
...
function hasFederationSpec(schemaOrAST) {
  ...
  if (isDocumentNode(schemaOrAST)) {
    return schemaOrAST.definitions.some((def) => def.kind === Kind30.DIRECTIVE_DEFINITION && federationDirectives.includes(def.name.value));
  }
  return false;
}
  ...
  if (schemaInstance && transformedDocuments.length > 0 && shouldValidateDocumentsAgainstSchema(skipDocumentsValidation)) {
    ...
    const errors = await profiler.run(() => {
      ...
      if (!schemaHash || !options.cache || transformedDocuments.some((d) => typeof d.hash !== "string")) {
        return Promise.resolve(validateGraphQlDocuments(schemaInstance, [
      ...
      return options.cache("documents-validation", cacheKey, () => Promise.resolve(validateGraphQlDocuments(schemaInstance, [
        ...transformedDocuments.flatMap((d) => d.document),
        ...fragments.flatMap((f) => f.document)
      ], rules)));
...
function validateDuplicateDocuments(files) {
  ...
  function addDefinition(file, node, deduplicatedDefinitions) {
    if (typeof node.name !== "undefined") {
      ...
      definitionKindMap[node.name.value].contents.add(print5(node));
...
var transformIntrospectionSchema = async (modelIntrospectionSchema) => {
  const result = await appsync.preset.buildGeneratesSection({
    baseOutputDir: "./",
    schema: parse5(modelIntrospectionSchema),
    config: {
