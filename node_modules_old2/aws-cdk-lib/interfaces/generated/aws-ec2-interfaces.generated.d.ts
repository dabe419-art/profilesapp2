 ...
 * @stability experimental
 */
export interface IApplicationStatusCheckRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ApplicationStatusCheck resource.
     */
    readonly applicationStatusCheckRef: ApplicationStatusCheckReference;
}
/**
 * A reference to a ApplicationStatusCheck resource.
 *
 ...
 * @stability external
 */
export interface ApplicationStatusCheckReference {
    /**
     * The Arn of the ApplicationStatusCheck resource.
     */
    readonly applicationStatusCheckArn: string;
}
/**
