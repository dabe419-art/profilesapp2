 ...
 *
 */
export declare class PolicyEngineMode {
    /**
     ...
     */
    static readonly LOG_ONLY: bedrockagentcore.PolicyEngineMode;
    /**
     * Enforces decisions by allowing or denying agent operations based on Cedar policies.
     */
    static readonly ENFORCE: bedrockagentcore.PolicyEngineMode;
    /**
     ...
     */
    static of(value: string): PolicyEngineMode;
    /**
...
export declare class Gateway extends GatewayBase {
     ...
     * @internal
     */
    private requestInterceptorConfig?;
    /**
     * The RESPONSE interceptor configuration
     * @internal
     */
    private responseInterceptorConfig?;
    /**
