 ...
 */
export declare const POLICY_ENGINE_EVALUATE_PERMS: string[];
/**
 ...
 */
export declare const POLICY_ENGINE_READ_PERMS: string[];
/**
 ...
 */
export declare const POLICY_READ_PERMS: string[];
