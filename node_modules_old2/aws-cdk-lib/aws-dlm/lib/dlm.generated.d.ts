...
export declare class CfnLifecyclePolicy extends cdk.CfnResource implements cdk.IInspectable, ILifecyclePolicyRef, cdk.ITaggable {
     ...
     */
    static fromLifecyclePolicyArn(scope: constructs.Construct, id: string, arn: string): ILifecyclePolicyRef;
    /**
     * Creates a new ILifecyclePolicyRef from a policyId
     */
    static fromPolicyId(scope: constructs.Construct, id: string, policyId: string): ILifecyclePolicyRef;
...
export declare namespace CfnLifecyclePolicy {
    ...
    interface ExclusionsProperty {
         ...
         */
        readonly excludeVolumeTypes?: Array<string>;
    }
    /**
     * @struct
     * @stability external
