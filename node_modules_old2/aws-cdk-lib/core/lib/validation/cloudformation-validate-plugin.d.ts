...
export declare class CloudFormationValidatePlugin implements IPolicyValidationPlugin {
     ...
     * @internal
     */
    static _configureSingleton(props: CloudFormationValidatePluginProps): void;
